...
# Introdução ao Manual SbD – Theory of Everything {index}
...
## 🧭 Precedência lógica entre capítulos {index#precedencia_logica_entre_capitulos}
...
## ⚖️ Fundamento: risco como critério orientador {index#fundamento_risco_como_criterio_orientador}
...
## 🛠️ Prescritivo, mas adaptável {index#prescritivo_mas_adaptavel}
...
## 🧩 Um manual para todas as organizações {index#um_manual_para_todas_as_organizacoes}
...
## 🧠 Aplicar com inteligência, não por obrigação {index#aplicar_com_inteligencia_nao_por_obrigacao}
...
## 🌐 A base de todos os outros manuais {index#a_base_de_todos_os_outros_manuais}
...
## 🚀 O que se consegue com o SbD-ToE {index#o_que_se_consegue_com_o_sbd_toe}
...
## 📌 Sobre a Cobertura e os Gaps {index#sobre_a_cobertura_e_os_gaps}
...
## 🙏 Nota de Agradecimento {index#nota_de_agradecimento}
