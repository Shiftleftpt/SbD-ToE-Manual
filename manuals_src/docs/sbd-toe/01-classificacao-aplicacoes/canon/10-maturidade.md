...
# 📈 Maturidade — Classificação da Criticidade Aplicacional {classificacao-aplicacoes:canon:maturidade}
...
## 🎯 Como interpretar este mapeamento de maturidade {classificacao-aplicacoes:canon:maturidade#como_interpretar_este_mapeamento_de_maturidade}
...
### Tipos de Avaliação Utilizados {classificacao-aplicacoes:canon:maturidade#tipos_de_avaliacao_utilizados}
...
## 🧭 Visão Geral de Alinhamento {classificacao-aplicacoes:canon:maturidade#visao_geral_de_alinhamento}
...
## 🧱 OWASP SAMM – Governance → Risk Management {classificacao-aplicacoes:canon:maturidade#owasp_samm__governance__risk_management}
...
## 🧱 OWASP DSOMM – Governance, Risk Management, Requirements {classificacao-aplicacoes:canon:maturidade#owasp_dsomm__governance_risk_management_requirements}
...
## 🧱 NIST SSDF – Risk Management (RM) {classificacao-aplicacoes:canon:maturidade#nist_ssdf__risk_management_rm}
...
## 🧱 BSIMM – Strategy and Metrics {classificacao-aplicacoes:canon:maturidade#bsimm__strategy_and_metrics}
...
## 🧱 SLSA – Supply Chain Levels for Software Artifacts {classificacao-aplicacoes:canon:maturidade#slsa__supply_chain_levels_for_software_artifacts}
...
## ✅ Conclusão {classificacao-aplicacoes:canon:maturidade#conclusao}
