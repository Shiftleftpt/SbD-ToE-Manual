...
# 🏃‍♂️ Runners, Execução Isolada e Ambientes Controlados {containers-imagens:addon:runners-isolamento}

## 🌟 Objetivo {containers-imagens:addon:runners-isolamento#objetivo}
...
## 🧬 O que são runners e ambientes de execução {containers-imagens:addon:runners-isolamento#o_que_sao_runners_e_ambientes_de_execucao}
...
## 📘 Tipos de runners e níveis de risco {containers-imagens:addon:runners-isolamento#tipos_de_runners_e_niveis_de_risco}
...
## 🛠️ Como aplicar execução isolada {containers-imagens:addon:runners-isolamento#como_aplicar_execucao_isolada}
...
## 📂 Onde e como configurar {containers-imagens:addon:runners-isolamento#onde_e_como_configurar}
...
## ✅ Boas práticas {containers-imagens:addon:runners-isolamento#boas_praticas}
...
## 📎 Referências cruzadas {containers-imagens:addon:runners-isolamento#referencias_cruzadas}
...
| `10-maturidade.md`              | Uso de ambientes isolados é indicador de maturidade |
