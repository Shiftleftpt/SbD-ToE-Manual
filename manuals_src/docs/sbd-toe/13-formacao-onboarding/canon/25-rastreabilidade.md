...
# 📎 Rastreabilidade contra Frameworks — Capítulo 13: Formação e Onboarding Seguro {formacao-onboarding:canon:checklist-revisao}
...
## 📌 Tabela de Rastreabilidade {formacao-onboarding:canon:checklist-revisao#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {formacao-onboarding:canon:checklist-revisao#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {formacao-onboarding:canon:checklist-revisao#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {formacao-onboarding:canon:checklist-revisao#owasp_samm_v21}
...
### 🧱 OWASP DSOMM {formacao-onboarding:canon:checklist-revisao#owasp_dsomm}
...
### 📊 BSIMM13 {formacao-onboarding:canon:checklist-revisao#bsimm13}
...
### 🏛️ ISO/IEC 27001 {formacao-onboarding:canon:checklist-revisao#isoiec_27001}
...
### 📐 CIS Controls v8 {formacao-onboarding:canon:checklist-revisao#cis_controls_v8}
...
### 🔄 ENISA DevSecOps {formacao-onboarding:canon:checklist-revisao#enisa_devsecops}
...
## 🔗 Ligações com outros capítulos {formacao-onboarding:canon:checklist-revisao#ligacoes_com_outros_capitulos}
