...
- **Documentação (texto, figuras, gráficos):**  
  **Creative Commons Attribution–ShareAlike 4.0 International (CC BY-SA 4.0)**  
  Texto legal: https://creativecommons.org/licenses/by-sa/4.0/  
  Permite usar, partilhar e adaptar (incluindo para fins comerciais) **desde que**:
  1) haja **atribuição adequada**, e  
  2) os trabalhos derivados sejam distribuídos sob **a mesma licença**.

- **Código e snippets (quando existirem neste repositório):**  
  **Apache License 2.0**  
  Texto legal: https://www.apache.org/licenses/LICENSE-2.0

> **Nota:** Este ficheiro resume o modelo de licenciamento. Os termos vinculativos são os dos ficheiros `LICENSE` (CC BY-SA 4.0) e, quando aplicável, `LICENSE-CODE` (Apache-2.0), colocados na raiz do repositório.

## 2) Atribuição requerida (como creditar)
...
```text
Copyright (c) 2025 Pedro Farinha
