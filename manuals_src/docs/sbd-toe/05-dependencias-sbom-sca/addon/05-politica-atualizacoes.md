...
# ♻️ Políticas de Atualização de Dependências {dependencias-sbom-sca:addon:politica-atualizacoes}

## 🌟 Objetivo {dependencias-sbom-sca:addon:politica-atualizacoes#objetivo}
...
## ⏲ Princípios de atualização segura {dependencias-sbom-sca:addon:politica-atualizacoes#principios_de_atualizacao_segura}
...
## 🛠️ Mecanismos de controlo por linguagem {dependencias-sbom-sca:addon:politica-atualizacoes#mecanismos_de_controlo_por_linguagem}
...
## 🔧 Frequência recomendada de revisão {dependencias-sbom-sca:addon:politica-atualizacoes#frequencia_recomendada_de_revisao}
...
## 📅 Estratégias de atualização {dependencias-sbom-sca:addon:politica-atualizacoes#estrategias_de_atualizacao}
...
## 📄 Checklist de aplicação de updates {dependencias-sbom-sca:addon:politica-atualizacoes#checklist_de_aplicacao_de_updates}
...
## 🔗 Ligações com outros ficheiros {dependencias-sbom-sca:addon:politica-atualizacoes#ligacoes_com_outros_ficheiros}
