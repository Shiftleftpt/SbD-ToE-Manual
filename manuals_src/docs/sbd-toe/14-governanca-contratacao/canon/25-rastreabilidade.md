...
# 📎 Rastreabilidade contra Frameworks — Capítulo 14: Governança e Contratação Segura {governanca-contratacao:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {governanca-contratacao:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {governanca-contratacao:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {governanca-contratacao:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {governanca-contratacao:canon:rastreabilidade#owasp_samm_v21}
...
### 📊 BSIMM13 {governanca-contratacao:canon:rastreabilidade#bsimm13}
...
### 🏛️ ISO/IEC 27001 {governanca-contratacao:canon:rastreabilidade#isoiec_27001}
...
### 📐 CIS Controls v8 {governanca-contratacao:canon:rastreabilidade#cis_controls_v8}
...
### 🔄 ENISA Supply Chain / DevSecOps {governanca-contratacao:canon:rastreabilidade#enisa_supply_chain__devsecops}
...
### 🧮 OWASP DSOMM {governanca-contratacao:canon:rastreabilidade#owasp_dsomm}
...
| **Verification**         | Revalidações, métricas de conformidade, KPIs (`addon/06`, `canon/90`)      | 4 / 5  |
| **Policies & Standards** | Políticas formais aplicáveis a terceiros e fornecedores (`canon/60`, `addon/02`) | 5 / 5  |
...
## 🔗 Ligações com outros capítulos {governanca-contratacao:canon:rastreabilidade#ligacoes_com_outros_capitulos}
