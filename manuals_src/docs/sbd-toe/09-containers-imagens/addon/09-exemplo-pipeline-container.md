...
# 💪 Caso Prático – Pipeline Containerizado com Execução Segura {containers-imagens:addon:exemplo-pipeline-container}
...
## 📦 Estrutura da pipeline {containers-imagens:addon:exemplo-pipeline-container#estrutura_da_pipeline}
...
## 🔐 Passos principais implementados {containers-imagens:addon:exemplo-pipeline-container#passos_principais_implementados}
...
## 📜 Exemplo resumido do pipeline (GitHub Actions) {containers-imagens:addon:exemplo-pipeline-container#exemplo_resumido_do_pipeline_github_actions}
...
## ☸️ Execução controlada no Kubernetes {containers-imagens:addon:exemplo-pipeline-container#execucao_controlada_no_kubernetes}
...
## ✅ Resultados obtidos {containers-imagens:addon:exemplo-pipeline-container#resultados_obtidos}
...
## 🧹 Lições aprendidas {containers-imagens:addon:exemplo-pipeline-container#licoes_aprendidas}
...
## 📌 Referências cruzadas {containers-imagens:addon:exemplo-pipeline-container#referencias_cruzadas}
