...
# 🧪 Validação dos Requisitos de Segurança {requisitos-seguranca:addon:plano-validacao}
...
> 📌 Este ficheiro complementa o catálogo de requisitos (`addon/01-catalogo-requisitos.md`) e os modelos de rastreabilidade e verificação (`addon/06`, `canon/25` e `20`).

---

### 🔐 AUT — Autenticação e Gestão de Identidade {requisitos-seguranca:addon:plano-validacao#aut__autenticacao_e_gestao_de_identidade}
...
### 🔐 ENC — Dados Sensíveis e Criptografia {requisitos-seguranca:addon:plano-validacao#enc__dados_sensiveis_e_criptografia}
...
### ⚙️ CFG — Configuração Segura e Gestão de Parâmetros {requisitos-seguranca:addon:plano-validacao#cfg__configuracao_segura_e_gestao_de_parametros}
...
### 🧱 VAL — Validação e Sanitização de Dados {requisitos-seguranca:addon:plano-validacao#val__validacao_e_sanitizacao_de_dados}
...
## 🧾 LOG — Registo, Auditoria e Monitorização {requisitos-seguranca:addon:plano-validacao#log__registo_auditoria_e_monitorizacao}
...
## 📮 API — Segurança de APIs e Serviços Externos {requisitos-seguranca:addon:plano-validacao#api__seguranca_de_apis_e_servicos_externos}
...
## 🧩 Notas complementares {requisitos-seguranca:addon:plano-validacao#notas_complementares}
...
- Todos os identificadores devem estar presentes nas matrizes de aplicação (`addon/02`, `06`) e podem ser referenciados em checklists e artefactos técnicos.
