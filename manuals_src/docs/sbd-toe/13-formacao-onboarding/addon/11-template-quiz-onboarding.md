...
# 📝 Template de Quiz – Onboarding Técnico {formacao-onboarding:addon:quiz-onboarding}
...
## 🎯 Objetivo {formacao-onboarding:addon:quiz-onboarding#objetivo}
...
## 📦 Contexto de uso {formacao-onboarding:addon:quiz-onboarding#contexto_de_uso}
...
## 🧪 Exemplo de quiz: Dev em aplicação L2 {formacao-onboarding:addon:quiz-onboarding#exemplo_de_quiz_dev_em_aplicacao_l2}
...
## 📌 Boas práticas de utilização {formacao-onboarding:addon:quiz-onboarding#boas_praticas_de_utilizacao}
...
## 🔗 Ligações úteis {formacao-onboarding:addon:quiz-onboarding#ligacoes_uteis}
