...
title: Justificação e Origem da Estrutura de Requisitos
...
## Rationale para a Estrutura dos Requisitos Aplicacionais {requisitos-seguranca:rationale-catalogo#rationale_para_a_estrutura_dos_requisitos_aplicacionais}
...
### 🧩 Origem e Fundamento {requisitos-seguranca:rationale-catalogo#origem_e_fundamento}
...
### 🧠 Motivações para Ajustes {requisitos-seguranca:rationale-catalogo#motivacoes_para_ajustes}
...
### 🧷 Ligação aos Capítulos do Manual {requisitos-seguranca:rationale-catalogo#ligacao_aos_capitulos_do_manual}
