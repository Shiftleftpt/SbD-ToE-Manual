...
# ✅ Quiz de Validação — Formação para Terceiros {formacao-onboarding:addon:22-quiz-terceiros}
...
## 🧪 Perguntas de validação (exemplo base) {formacao-onboarding:addon:22-quiz-terceiros#perguntas_de_validacao_exemplo_base}
...
## 📋 Registo de resultado (modelo) {formacao-onboarding:addon:22-quiz-terceiros#registo_de_resultado_modelo}
...
## 🧭 Notas de utilização {formacao-onboarding:addon:22-quiz-terceiros#notas_de_utilizacao}
