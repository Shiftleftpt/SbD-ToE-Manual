...
# 🔐 Ameaças Mitigadas — Capítulo 14: Governança e Contratação Segura {governanca-contratacao:canon:ameacas-mitigadas}
...
## 🧯 Categoria 1 — Adoção de software ou serviços inseguros {governanca-contratacao:canon:ameacas-mitigadas#categoria_1__adocao_de_software_ou_servicos_inseguros}
...
## 🧱 Categoria 2 — Governança inconsistente ou ineficaz {governanca-contratacao:canon:ameacas-mitigadas#categoria_2__governanca_inconsistente_ou_ineficaz}
...
## 🔄 Categoria 3 — Falta de revisão e validação contínua {governanca-contratacao:canon:ameacas-mitigadas#categoria_3__falta_de_revisao_e_validacao_continua}
...
## 🧠 Categoria 4 — Ausência de maturidade e rastreabilidade estratégica {governanca-contratacao:canon:ameacas-mitigadas#categoria_4__ausencia_de_maturidade_e_rastreabilidade_estrategica}
...
| Estratégia de segurança desarticulada   | ENISA / BSIMM Strategy / DSOMM     | Iniciativas reativas ou não sustentadas              | Integração com KPIs, governance boards e decisão por risco                      | `canon/30`, `canon/90`                         |

---

## 🚫 Categoria 5 — Falha de enforcement organizacional {governanca-contratacao:canon:ameacas-mitigadas#categoria_5__falha_de_enforcement_organizacional}

| Ameaça                                        | Fonte                        | Como surge                                                     | Como a prática mitiga                                                                  | Controlos associados                              |
|-----------------------------------------------|-------------------------------|----------------------------------------------------------------|-----------------------------------------------------------------------------------------|---------------------------------------------------|
| Segurança definida mas não aplicada           | DSOMM Governance              | Falta de owners, exceções não justificadas                    | Governação com owners atribuídos, exceções formais, revalidações obrigatórias          | `addon/01`, `addon/05`, `addon/06`, `canon/60`     |
| Políticas de segurança não institucionalizadas| DSOMM Policies / ISO 27001 A.5| Políticas existem mas não são formalmente aplicadas ou auditadas| Políticas organizacionais auditáveis com ligação direta a contratos e exceções         | `canon/60-politicas-recomendadas.md`              |

---

## ✅ Conclusão {governanca-contratacao:canon:ameacas-mitigadas#conclusao}
