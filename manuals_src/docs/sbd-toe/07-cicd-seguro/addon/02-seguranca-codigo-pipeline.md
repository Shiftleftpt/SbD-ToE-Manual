...
# 🔒 Segurança do código dentro do pipeline {cicd-seguro:addon:seguranca-codigo-pipeline}
...
## 🎯 Objetivos {cicd-seguro:addon:seguranca-codigo-pipeline#objetivos}
...
## 🛠️ Práticas {cicd-seguro:addon:seguranca-codigo-pipeline#praticas}
...
## ⚖️ Aplicação proporcional por nível de risco {cicd-seguro:addon:seguranca-codigo-pipeline#aplicacao_proporcional_por_nivel_de_risco}
...
## 📌 Exemplos práticos {cicd-seguro:addon:seguranca-codigo-pipeline#exemplos_praticos}
...
## 📉 Riscos mitigados {cicd-seguro:addon:seguranca-codigo-pipeline#riscos_mitigados}
...
## 🧭 Referências {cicd-seguro:addon:seguranca-codigo-pipeline#referencias}
