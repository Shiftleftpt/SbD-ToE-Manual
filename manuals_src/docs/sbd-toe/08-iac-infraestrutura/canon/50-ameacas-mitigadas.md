...
# 🔐 Ameaças Mitigadas — Capítulo 08: IaC e Infraestrutura como Código {iac-infraestrutura:canon:ameacas-mitigadas}
...
## ⚙️ Categoria 1 – Erros de configuração e falhas de validação {iac-infraestrutura:canon:ameacas-mitigadas#categoria_1__erros_de_configuracao_e_falhas_de_validacao}
...
## 🏗️ Categoria 2 – Falhas na definição e controlo de arquitetura de IaC {iac-infraestrutura:canon:ameacas-mitigadas#categoria_2__falhas_na_definicao_e_controlo_de_arquitetura_de_iac}
...
## 🔐 Categoria 3 – Exposição de dados, chaves ou permissões excessivas {iac-infraestrutura:canon:ameacas-mitigadas#categoria_3__exposicao_de_dados_chaves_ou_permissoes_excessivas}
...
## 🔁 Categoria 4 – Falta de rastreabilidade e visibilidade de alterações {iac-infraestrutura:canon:ameacas-mitigadas#categoria_4__falta_de_rastreabilidade_e_visibilidade_de_alteracoes}
...
## 📉 Categoria 5 – Falta de enforcement e exceções não geridas {iac-infraestrutura:canon:ameacas-mitigadas#categoria_5__falta_de_enforcement_e_excecoes_nao_geridas}
...
| Ambientes provisionados com exceções acumuladas | OWASP IaC / BSIMM13 / DSOMM          | Sem política de revisão ou limpeza de exceções  | Ciclo de vida com reapreciação e auditoria contínua                              | `canon/15-aplicacao-lifecycle.md`           | ❌ Cap. 01                             |

---

## ✅ Conclusão {iac-infraestrutura:canon:ameacas-mitigadas#conclusao}
