...
# 📈 Maturidade — Governança e Contratação {governanca-contratacao:canon:maturidade}
...
## 🎯 Como interpretar este mapeamento de maturidade {governanca-contratacao:canon:maturidade#como_interpretar_este_mapeamento_de_maturidade}
...
## 🧭 Visão Geral de Alinhamento {governanca-contratacao:canon:maturidade#visao_geral_de_alinhamento}
...
## 🧱 OWASP SAMM – Governance e Education {governanca-contratacao:canon:maturidade#owasp_samm__governance_e_education}
...
## 🧱 OWASP DSOMM {governanca-contratacao:canon:maturidade#owasp_dsomm}
...
## 🧱 NIST SSDF – Controlos Cumpridos {governanca-contratacao:canon:maturidade#nist_ssdf__controlos_cumpridos}
...
## 🧱 BSIMM – Governance & Compliance {governanca-contratacao:canon:maturidade#bsimm__governance__compliance}
...
## 🧱 SLSA – Supply Chain {governanca-contratacao:canon:maturidade#slsa__supply_chain}
...
## ✅ Conclusão {governanca-contratacao:canon:maturidade#conclusao}
