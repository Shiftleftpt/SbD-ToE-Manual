...
# Dependências, SBOM e SCA {cap05:intro}

## 🧠 Enquadramento e Rationale {cap05:intro#enquadramento}
...
## 🔎 Nota metodológica {cap05:intro#nota}
...
## 🧭 O que cobre tecnicamente {cap05:intro#cobre}
...
## 🧪 Pilares de governação {cap05:intro#pilares}
...
## ⚙️ Como deve ser feito {cap05:intro#como}
...
## 📆 Quando aplicar {cap05:intro#quando}
...
## 👥 Quem está envolvido {cap05:intro#quem}
...
## 🧮 Aplicação proporcional L1–L3 {cap05:intro#proporcionalidade}
...
## 📜 Políticas Organizacionais Relevantes {cap05:intro#politicas}
