...
# 📈 Maturidade — Dependências, SBOM e SCA {dependencias-sbom-sca:canon:maturidade}
...
## 🎯 Como interpretar este mapeamento de maturidade {dependencias-sbom-sca:canon:maturidade#como_interpretar_este_mapeamento_de_maturidade}
...
## 🧭 Visão Geral de Alinhamento {dependencias-sbom-sca:canon:maturidade#visao_geral_de_alinhamento}
...
## 🧱 OWASP SAMM – Construction → Dependency Management {dependencias-sbom-sca:canon:maturidade#owasp_samm__construction__dependency_management}
...
## 🧱 OWASP DSOMM – Policy, Build & Deploy, Tooling {dependencias-sbom-sca:canon:maturidade#owasp_dsomm__policy_build__deploy_tooling}
...
## 🧱 NIST SSDF – Dependências e Validação {dependencias-sbom-sca:canon:maturidade#nist_ssdf__dependencias_e_validacao}
...
## 🧱 BSIMM – Software Environment e Segurança Operacional {dependencias-sbom-sca:canon:maturidade#bsimm__software_environment_e_seguranca_operacional}
...
## 🧱 SLSA – Provenance & Dependency Control {dependencias-sbom-sca:canon:maturidade#slsa__provenance__dependency_control}
...
## ✅ Conclusão {dependencias-sbom-sca:canon:maturidade#conclusao}
