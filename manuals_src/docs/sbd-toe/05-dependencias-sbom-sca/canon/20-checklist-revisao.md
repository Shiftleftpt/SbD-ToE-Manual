...
# ✅ Checklist de Revisão Periódica — Dependências, SBOM e SCA {dependencias-sbom-sca:canon:checklist-revisao}
...
## 📋 Itens de Verificação {dependencias-sbom-sca:canon:checklist-revisao#itens_de_verificacao}
...
## 🔄 Integração Operacional {dependencias-sbom-sca:canon:checklist-revisao#integracao_operacional}
...
## ✅ Conformidade e KPI {dependencias-sbom-sca:canon:checklist-revisao#conformidade_e_kpi}
