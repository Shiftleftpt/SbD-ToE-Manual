...
# ✅ Checklist de Revisão Periódica — Governança e Contratação {governanca-contratacao:canon:checklist-revisao}
...
## 📋 Itens de Verificação {governanca-contratacao:canon:checklist-revisao#itens_de_verificacao}
...
| As políticas organizacionais relacionadas com segurança, contratação e exceções estão formalmente aprovadas e auditadas (`canon/60`)? | ☐           |
...
## 🔄 Integração Operacional {governanca-contratacao:canon:checklist-revisao#integracao_operacional}
...
## 🎯 Conformidade e Indicadores {governanca-contratacao:canon:checklist-revisao#conformidade_e_indicadores}
...
## 🔗 Ligações cruzadas {governanca-contratacao:canon:checklist-revisao#ligacoes_cruzadas}
