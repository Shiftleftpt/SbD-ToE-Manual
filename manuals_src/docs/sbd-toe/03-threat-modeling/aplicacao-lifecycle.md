...
# 🔄 Aplicação de Threat Modeling no Ciclo de Vida {threat-modeling:aplicacao-lifecycle}
...
## 📅 Quando aplicar Threat Modeling {threat-modeling:aplicacao-lifecycle#quando_aplicar}
...
## 👥 Quem faz o quê {threat-modeling:aplicacao-lifecycle#quem_faz_o_que}
...
## 📝 User Stories e Cartões Reutilizáveis {threat-modeling:aplicacao-lifecycle#user_stories}
### US-01 – Criação do modelo de ameaça {#us-01}
...
### US-02 – Validação de arquitetura com threat modeling {#us-02}
...
### US-03 – Atualização do modelo após alteração técnica {#us-03}
...
---
### US-04 – Justificação formal de risco aceite {#us-04}
...
**Ligações úteis.**
- 🔗 [Gestão de exceções e risco residual](xref:sbd-toe:toe:02-requisitos-seguranca:gestao-excecoes)  

---

### US-05 – Integração com CI/CD {#us-05}
...
---
### US-07 – Automação e reutilização de modelos {#us-07}
...
## ⚖️ Aplicação proporcional por nível de risco (L1–L2–L3) {threat-modeling:aplicacao-lifecycle#aplicacao_proporcional_por_nivel_de_risco_l1l2l3}
...
## 📄 Templates e artefactos esperados {threat-modeling:aplicacao-lifecycle#templates_e_artefactos_esperados}
