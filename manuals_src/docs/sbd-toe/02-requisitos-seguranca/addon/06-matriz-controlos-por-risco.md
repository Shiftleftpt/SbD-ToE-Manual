...
title: Matriz de Aplicação de Requisitos por Nível de Risco
...
# 🧩 Matriz de Aplicação de Requisitos por Nível de Risco {requisitos-seguranca:addon:matriz-controlos-por-risco}
...
> Consulte o [catálogo completo de requisitos aplicacionais](xref:sbd-toe:toe:02-requisitos-seguranca:catalogo-requisitos) para ver os detalhes por requisito e nível.
...
> - [01-catalogo-requisitos-aplicacionais.md](xref:sbd-toe:toe:02-requisitos-seguranca:catalogo-requisitos)
> - [03-rastreabilidade-frameworks.md](xref:sbd-toe:toe:01-classificacao-aplicacoes:rastreabilidade)
