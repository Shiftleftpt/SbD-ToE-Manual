...
# 🤝 Guidelines de Equipa e Práticas Partilhadas {desenvolvimento-seguro:addon:guidelines-equipa}
...
## 📌 Objetivos {desenvolvimento-seguro:addon:guidelines-equipa#objetivos}
...
## 👥 Quem deve aplicar {desenvolvimento-seguro:addon:guidelines-equipa#quem_deve_aplicar}
...
## ⏱️ Quando aplicar {desenvolvimento-seguro:addon:guidelines-equipa#quando_aplicar}
...
## 🧱 Requisitos recomendados {desenvolvimento-seguro:addon:guidelines-equipa#requisitos_recomendados}
...
## ✅ Como validar {desenvolvimento-seguro:addon:guidelines-equipa#como_validar}
...
## 🧾 Como evidenciar {desenvolvimento-seguro:addon:guidelines-equipa#como_evidenciar}
...
## 🔄 Ligação a outras práticas {desenvolvimento-seguro:addon:guidelines-equipa#ligacao_a_outras_praticas}
