...
# 📝 Justificação Formal de Exceções {desenvolvimento-seguro:addon:excecoes-e-justificacoes}
...
## 📌 Objetivos {desenvolvimento-seguro:addon:excecoes-e-justificacoes#objetivos}
...
## 👥 Quem deve aplicar {desenvolvimento-seguro:addon:excecoes-e-justificacoes#quem_deve_aplicar}
...
## ⏱️ Quando aplicar {desenvolvimento-seguro:addon:excecoes-e-justificacoes#quando_aplicar}
...
## 🧱 Requisitos mínimos {desenvolvimento-seguro:addon:excecoes-e-justificacoes#requisitos_minimos}
...
## ✅ Como validar {desenvolvimento-seguro:addon:excecoes-e-justificacoes#como_validar}
...
## 🧾 Como evidenciar {desenvolvimento-seguro:addon:excecoes-e-justificacoes#como_evidenciar}
...
## 🔄 Ligação a outras práticas {desenvolvimento-seguro:addon:excecoes-e-justificacoes#ligacao_a_outras_praticas}
