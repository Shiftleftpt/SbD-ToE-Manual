...
# 🛂 Políticas e gates por nível de aplicação {cicd-seguro:addon:politicas-gates-pipeline}
...
## 🎯 Objetivos {cicd-seguro:addon:politicas-gates-pipeline#objetivos}
...
## 🛠️ Práticas {cicd-seguro:addon:politicas-gates-pipeline#praticas}
...
## ⚖️ Aplicação proporcional por nível de risco {cicd-seguro:addon:politicas-gates-pipeline#aplicacao_proporcional_por_nivel_de_risco}
...
## 📌 Exemplos práticos {cicd-seguro:addon:politicas-gates-pipeline#exemplos_praticos}
...
## 📉 Riscos mitigados {cicd-seguro:addon:politicas-gates-pipeline#riscos_mitigados}
...
## 🧭 Referências {cicd-seguro:addon:politicas-gates-pipeline#referencias}
