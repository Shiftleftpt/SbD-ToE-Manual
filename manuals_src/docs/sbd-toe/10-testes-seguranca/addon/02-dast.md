...
# 🌐 Testes Dinâmicos de Segurança (DAST) {testes-seguranca:addon:dast}

## 🌟 Objetivo {testes-seguranca:addon:dast#objetivo}
...
## 🔍 O que é DAST {testes-seguranca:addon:dast#o_que_e_dast}
...
## ⚙️ Como aplicar {testes-seguranca:addon:dast#como_aplicar}
...
## ✅ Boas práticas {testes-seguranca:addon:dast#boas_praticas}
...
## 📎 Referências cruzadas {testes-seguranca:addon:dast#referencias_cruzadas}
