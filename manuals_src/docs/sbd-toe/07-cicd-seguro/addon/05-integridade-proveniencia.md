...
# 📦 Integridade e proveniência de artefactos {cicd-seguro:addon:integridade-proveniencia}
...
## 🎯 Objetivos {cicd-seguro:addon:integridade-proveniencia#objetivos}
...
## 🛠️ Práticas {cicd-seguro:addon:integridade-proveniencia#praticas}
...
## ⚖️ Aplicação proporcional por nível de risco {cicd-seguro:addon:integridade-proveniencia#aplicacao_proporcional_por_nivel_de_risco}
...
## 📌 Exemplos práticos {cicd-seguro:addon:integridade-proveniencia#exemplos_praticos}
...
## 📉 Riscos mitigados {cicd-seguro:addon:integridade-proveniencia#riscos_mitigados}
...
## 🧭 Referências {cicd-seguro:addon:integridade-proveniencia#referencias}
