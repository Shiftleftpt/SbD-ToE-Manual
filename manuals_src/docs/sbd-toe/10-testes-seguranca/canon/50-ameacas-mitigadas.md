...
# 🔐 Ameaças Mitigadas — Capítulo 10: Testes de Segurança {testes-seguranca:canon:ameacas-mitigadas}
...
## 🧪 Categoria 1 – Vulnerabilidades no código ou lógica de aplicação {testes-seguranca:canon:ameacas-mitigadas#categoria_1__vulnerabilidades_no_codigo_ou_logica_de_aplicacao}
...
## 🔍 Categoria 2 – Defeitos regressivos e falhas reintroduzidas {testes-seguranca:canon:ameacas-mitigadas#categoria_2__defeitos_regressivos_e_falhas_reintroduzidas}
...
## ⚠️ Categoria 3 – Falta de visibilidade sobre falhas de segurança {testes-seguranca:canon:ameacas-mitigadas#categoria_3__falta_de_visibilidade_sobre_falhas_de_seguranca}
...
## 🛠️ Categoria 4 – Falta de integração no ciclo de vida {testes-seguranca:canon:ameacas-mitigadas#categoria_4__falta_de_integracao_no_ciclo_de_vida}
...
| Falta de testes antes de go-live           | ISO 27034 / SSDF PW.7              | Deploy feito sem cobertura mínima validada         | Checklist com critérios de testes mínimos e rastreio de resultados             | `canon/20-checklist-revisao.md`               | ❌ Cap. 01                             |
...
## 🧐 Categoria 5 – Incapacidade de detetar novas classes de vulnerabilidades {testes-seguranca:canon:ameacas-mitigadas#categoria_5__incapacidade_de_detetar_novas_classes_de_vulnerabilidades}
...
## ✅ Conclusão {testes-seguranca:canon:ameacas-mitigadas#conclusao}
