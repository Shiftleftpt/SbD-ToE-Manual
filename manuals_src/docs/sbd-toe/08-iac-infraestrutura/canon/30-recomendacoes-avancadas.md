---
id: recomendacoes-avancadas-iac
...
# 🔐 Recomendações Avançadas para IaC Seguro {iac-infraestrutura:canon:recomendacoes-avancadas-iac}
...
## 📌 Enforcement político e semântico com OPA / Sentinel {iac-infraestrutura:canon:recomendacoes-avancadas-iac#enforcement_politico_e_semantico_com_opa__sentinel}
...
## 📊 Proveniência e rastreabilidade reforçada {iac-infraestrutura:canon:recomendacoes-avancadas-iac#proveniencia_e_rastreabilidade_reforcada}
...
## 🔁 Integração com custo e “drift” {iac-infraestrutura:canon:recomendacoes-avancadas-iac#integracao_com_custo_e_drift}
...
## 🔐 Segurança na proveniência de módulos {iac-infraestrutura:canon:recomendacoes-avancadas-iac#seguranca_na_proveniencia_de_modulos}
...
## 🧪 Testes programáticos de infraestrutura {iac-infraestrutura:canon:recomendacoes-avancadas-iac#testes_programaticos_de_infraestrutura}
...
## 📋 Governação de exceções técnicas {iac-infraestrutura:canon:recomendacoes-avancadas-iac#governacao_de_excecoes_tecnicas}
...
## ✅ Conclusão {iac-infraestrutura:canon:recomendacoes-avancadas-iac#conclusao}
