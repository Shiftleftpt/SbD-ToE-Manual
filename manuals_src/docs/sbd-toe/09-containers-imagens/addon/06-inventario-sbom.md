...
# 🧬 SBOM de *containers* e Rastreabilidade de Runtime {containers-imagens:addon:sbom-containers}

## 🌟 Objetivo {containers-imagens:addon:sbom-containers#objetivo}
...
## 🧬 O que é um SBOM de *container* {containers-imagens:addon:sbom-containers#o_que_e_um_sbom_de_container}
...
## 📘 Formatos e ferramentas recomendadas {containers-imagens:addon:sbom-containers#formatos_e_ferramentas_recomendadas}
...
## 🛠️ Como gerar SBOMs de *containers* {containers-imagens:addon:sbom-containers#como_gerar_sboms_de_containers}
...
## 📂 Onde armazenar e como versionar {containers-imagens:addon:sbom-containers#onde_armazenar_e_como_versionar}
...
## ✅ Boas práticas {containers-imagens:addon:sbom-containers#boas_praticas}
...
## 📎 Referências cruzadas {containers-imagens:addon:sbom-containers#referencias_cruzadas}
...
| `10-maturidade.md`              | Geração e uso de SBOM são critério de maturidade|
