...
# ☸️ Execução Segura de *containers* em Clusters Kubernetes {containers-imagens:addon:kubernetes-execucao}

## 🌟 Objetivo {containers-imagens:addon:kubernetes-execucao#objetivo}
...
## 🧬 O que significa execução segura em Kubernetes {containers-imagens:addon:kubernetes-execucao#o_que_significa_execucao_segura_em_kubernetes}
...
## 📘 Mecanismos de segurança aplicáveis {containers-imagens:addon:kubernetes-execucao#mecanismos_de_seguranca_aplicaveis}
...
## 🛠️ Como aplicar na prática {containers-imagens:addon:kubernetes-execucao#como_aplicar_na_pratica}
...
## 📂 Onde configurar e versionar {containers-imagens:addon:kubernetes-execucao#onde_configurar_e_versionar}
...
## ✅ Boas práticas {containers-imagens:addon:kubernetes-execucao#boas_praticas}
...
## 📎 Referências cruzadas {containers-imagens:addon:kubernetes-execucao#referencias_cruzadas}
...
| `10-maturidade.md`              | Aplicação de PSA e policies é critério de maturidade|
