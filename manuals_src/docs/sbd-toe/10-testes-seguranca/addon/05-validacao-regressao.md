...
# 🔁 Validação de Regressões de Segurança {testes-seguranca:addon:validacao-regressao}

## 🌟 Objetivo {testes-seguranca:addon:validacao-regressao#objetivo}
...
## 🔍 O que é validação de regressões {testes-seguranca:addon:validacao-regressao#o_que_e_validacao_de_regressoes}
...
## ⚙️ Como aplicar {testes-seguranca:addon:validacao-regressao#como_aplicar}
...
## ✅ Boas práticas {testes-seguranca:addon:validacao-regressao#boas_praticas}
...
## 📎 Referências cruzadas {testes-seguranca:addon:validacao-regressao#referencias_cruzadas}
