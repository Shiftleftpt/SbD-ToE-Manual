...
# 📈 Maturidade — Deploy Seguro {deploy-seguro:canon:maturidade}
...
## 🎯 Como interpretar este mapeamento de maturidade {deploy-seguro:canon:maturidade#como_interpretar_este_mapeamento_de_maturidade}
...
## 🧭 Visão Geral de Alinhamento {deploy-seguro:canon:maturidade#visao_geral_de_alinhamento}
...
## 🧱 OWASP SAMM – Verification → Security Testing {deploy-seguro:canon:maturidade#owasp_samm__verification__security_testing}
...
## 🧱 OWASP DSOMM – Deploy Seguro como Domínio Técnico {deploy-seguro:canon:maturidade#owasp_dsomm__deploy_seguro_como_dominio_tecnico}
...
## 🧱 NIST SSDF – Requisitos de Execução Autorizada {deploy-seguro:canon:maturidade#nist_ssdf__requisitos_de_execucao_autorizada}
...
## 🧱 BSIMM – Práticas de Governança de Deployment {deploy-seguro:canon:maturidade#bsimm__praticas_de_governanca_de_deployment}
...
## 🧱 SLSA – Controlo de Build e Proveniência {deploy-seguro:canon:maturidade#slsa__controlo_de_build_e_proveniencia}
...
## ✅ Conclusão {deploy-seguro:canon:maturidade#conclusao}
