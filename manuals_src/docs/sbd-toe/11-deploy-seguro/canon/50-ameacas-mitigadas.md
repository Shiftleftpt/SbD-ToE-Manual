...
# 🔐 Ameaças Mitigadas — Capítulo 11: Deploy e Controlo de Execução {deploy-seguro:canon:ameacas-mitigadas}
...
## 🚨 Categoria 1 – Execução de código não validado {deploy-seguro:canon:ameacas-mitigadas#categoria_1__execucao_de_codigo_nao_validado}
...
## 🔁 Categoria 2 – Ausência de rollback e reversibilidade {deploy-seguro:canon:ameacas-mitigadas#categoria_2__ausencia_de_rollback_e_reversibilidade}
...
## 🧪 Categoria 3 – Validação deficiente em produção {deploy-seguro:canon:ameacas-mitigadas#categoria_3__validacao_deficiente_em_producao}
...
## 📉 Categoria 4 – Falta de monitorização e resposta a falhas {deploy-seguro:canon:ameacas-mitigadas#categoria_4__falta_de_monitorizacao_e_resposta_a_falhas}
...
## 🔒 Categoria 5 – Exposição acidental de funcionalidades {deploy-seguro:canon:ameacas-mitigadas#categoria_5__exposicao_acidental_de_funcionalidades}
...
## ✅ Conclusão {deploy-seguro:canon:ameacas-mitigadas#conclusao}
