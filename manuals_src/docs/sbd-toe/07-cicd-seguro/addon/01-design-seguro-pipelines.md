...
# 🧱 Design seguro dos pipelines {cicd-seguro:addon:design-seguro-pipelines}
...
## 🎯 Objetivos {cicd-seguro:addon:design-seguro-pipelines#objetivos}
...
## 🛠️ Práticas {cicd-seguro:addon:design-seguro-pipelines#praticas}
...
## ⚖️ Aplicação proporcional por nível de risco {cicd-seguro:addon:design-seguro-pipelines#aplicacao_proporcional_por_nivel_de_risco}
...
## 📌 Exemplos práticos {cicd-seguro:addon:design-seguro-pipelines#exemplos_praticos}
...
## 📉 Riscos mitigados {cicd-seguro:addon:design-seguro-pipelines#riscos_mitigados}
...
## 🧭 Referências {cicd-seguro:addon:design-seguro-pipelines#referencias}
