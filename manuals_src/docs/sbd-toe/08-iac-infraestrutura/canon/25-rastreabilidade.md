...
# 📎 Rastreabilidade contra Frameworks — Capítulo 08: IaC e Infraestrutura como Código {iac-infraestrutura:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {iac-infraestrutura:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {iac-infraestrutura:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {iac-infraestrutura:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {iac-infraestrutura:canon:rastreabilidade#owasp_samm_v21}
...
### 📊 BSIMM13 {iac-infraestrutura:canon:rastreabilidade#bsimm13}
...
### 🔐 SLSA v1.0 {iac-infraestrutura:canon:rastreabilidade#slsa_v10}

Capítulo suporta:
- Proveniência de planos e artefactos (`addon/07`);
- Controlo de alterações com assinatura e enforcement (`addon/06`);
- Modularização e controlo por políticas internas (`canon/60`).

---

### 🏛️ ISO/IEC 27001 {iac-infraestrutura:canon:rastreabilidade#isoiec_27001}
...
### 📐 CIS Controls v8 {iac-infraestrutura:canon:rastreabilidade#cis_controls_v8}
...
### 🔄 ENISA DevSecOps {iac-infraestrutura:canon:rastreabilidade#enisa_devsecops}
...
### 🧬 OWASP DSOMM {iac-infraestrutura:canon:rastreabilidade#owasp_dsomm}
...
| **Control Mapping**           | Enforcement com OPA/Conftest + políticas (`canon/60`)    | ✅ Completo |
...
## 🔗 Ligações com outros capítulos {iac-infraestrutura:canon:rastreabilidade#ligacoes_com_outros_capitulos}
