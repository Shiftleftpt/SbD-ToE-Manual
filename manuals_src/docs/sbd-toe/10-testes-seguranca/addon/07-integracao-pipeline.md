...
# 🛠️ Integração dos Testes de Segurança no Pipeline CI/CD {testes-seguranca:addon:integracao-pipeline}

## 🌟 Objetivo {testes-seguranca:addon:integracao-pipeline#objetivo}
...
## 🔍 O que significa “integrar testes no pipeline” {testes-seguranca:addon:integracao-pipeline#o_que_significa_integrar_testes_no_pipeline}
...
## ⚙️ Como aplicar {testes-seguranca:addon:integracao-pipeline#como_aplicar}
...
## ✅ Boas práticas {testes-seguranca:addon:integracao-pipeline#boas_praticas}
...
## 📎 Referências cruzadas {testes-seguranca:addon:integracao-pipeline#referencias_cruzadas}
