...
# ✅ Checklist de Revisão Periódica de Práticas de IaC {iac-infraestrutura:canon:checklist-revisao}
...
## 📋 Itens de Verificação {iac-infraestrutura:canon:checklist-revisao#itens_de_verificacao}
...
## 🔄 Integração Operacional {iac-infraestrutura:canon:checklist-revisao#integracao_operacional}
...
## 📊 Conformidade e KPI {iac-infraestrutura:canon:checklist-revisao#conformidade_e_kpi}
