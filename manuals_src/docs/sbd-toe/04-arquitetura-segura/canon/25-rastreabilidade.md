...
# 📎 Rastreabilidade contra Frameworks — Capítulo 04: Arquitetura Segura {arquitetura-segura:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {arquitetura-segura:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas Explicativas por Framework {arquitetura-segura:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {arquitetura-segura:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {arquitetura-segura:canon:rastreabilidade#owasp_samm_v21}
...
### 📊 BSIMM13 {arquitetura-segura:canon:rastreabilidade#bsimm13}
...
### 🏛️ ISO/IEC 27001 {arquitetura-segura:canon:rastreabilidade#isoiec_27001}
...
### 🔐 ISO/IEC 27034 {arquitetura-segura:canon:rastreabilidade#isoiec_27034}
...
### 🧬 SLSA v1.0 {arquitetura-segura:canon:rastreabilidade#slsa_v10}
...
### 🧱 CIS Controls v8 {arquitetura-segura:canon:rastreabilidade#cis_controls_v8}
...
### 🛰️ ENISA SDLC / DevSecOps {arquitetura-segura:canon:rastreabilidade#enisa_sdlc__devsecops}
...
### 🧩 OWASP DSOMM — Design & Development {arquitetura-segura:canon:rastreabilidade#owasp_dsomm__design__development}
...
## 🔗 Ligações com Outros Capítulos {arquitetura-segura:canon:rastreabilidade#ligacoes_com_outros_capitulos}
...
## ✅ Conclusão {arquitetura-segura:canon:rastreabilidade#conclusao}
