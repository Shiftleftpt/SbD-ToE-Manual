...
# 🛠️ Modelo de Validação de Fornecedores e Terceiros {governanca-contratacao:addon:modelo-validacao-fornecedores}
...
## 🔁 Como aplicar {governanca-contratacao:addon:modelo-validacao-fornecedores#como_aplicar}

### 📊 Fluxo de validação típico {governanca-contratacao:addon:modelo-validacao-fornecedores#fluxo_de_validacao_tipico}
...
## 🧲 Critérios de validação por risco {governanca-contratacao:addon:modelo-validacao-fornecedores#criterios_de_validacao_por_risco}
...
## 📝 Exemplos práticos {governanca-contratacao:addon:modelo-validacao-fornecedores#exemplos_praticos}

### ✔️ Aprovação normal (nível L2) {governanca-contratacao:addon:modelo-validacao-fornecedores#aprovacao_normal_nivel_l2}

* Questionário preenchido com sucesso
* Política de vulnerabilidades apresentada
* Cláusulas contratuais alinhadas com Cap. 2

### ❌ Rejeição (nível L3) {governanca-contratacao:addon:modelo-validacao-fornecedores#rejeicao_nivel_l3}

* Recusa de cláusulas sobre incidentes
* Ausência de SBOM ou testes externos
* Rejeitado por não cumprir exigências críticas

### ⚠️ Exceção aprovada (nível L3) {governanca-contratacao:addon:modelo-validacao-fornecedores#excecao_aprovada_nivel_l3}
...
## 🗂️ Exemplos de questionário de segurança (excerto) {governanca-contratacao:addon:modelo-validacao-fornecedores#exemplos_de_questionario_de_seguranca_excerto}
