...
# 🛠️ Governação de Sistemas Legados e Contextos Não Conformes {governanca-contratacao:addon:governanca-legada}
...
## 🌟 Objetivo {governanca-contratacao:addon:governanca-legada#objetivo}
...
## 🧰 Contextos típicos {governanca-contratacao:addon:governanca-legada#contextos_tipicos}
...
## 🛠️ Abordagem proposta {governanca-contratacao:addon:governanca-legada#abordagem_proposta}
...
## 📋 Exemplo de registo de governação de legado {governanca-contratacao:addon:governanca-legada#exemplo_de_registo_de_governacao_de_legado}
...
## ✅ Recomendações {governanca-contratacao:addon:governanca-legada#recomendacoes}
...
## 🔗 Ligações cruzadas {governanca-contratacao:addon:governanca-legada#ligacoes_cruzadas}
