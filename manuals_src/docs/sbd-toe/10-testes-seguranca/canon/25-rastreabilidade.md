...
# 📎 Rastreabilidade contra Frameworks — Capítulo 10: Testes de Segurança {testes-seguranca:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {testes-seguranca:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {testes-seguranca:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {testes-seguranca:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {testes-seguranca:canon:rastreabilidade#owasp_samm_v21}
...
### 📊 BSIMM13 {testes-seguranca:canon:rastreabilidade#bsimm13}
...
### 🏛️ ISO/IEC 27001 {testes-seguranca:canon:rastreabilidade#isoiec_27001}
...
### 🔐 ISO/IEC 27034 {testes-seguranca:canon:rastreabilidade#isoiec_27034}
...
### 📐 CIS Controls v8 {testes-seguranca:canon:rastreabilidade#cis_controls_v8}
...
### 🔄 ENISA DevSecOps {testes-seguranca:canon:rastreabilidade#enisa_devsecops}
...
### 🧪 OWASP DSOMM {testes-seguranca:canon:rastreabilidade#owasp_dsomm}
...
## 🔗 Ligações com outros capítulos {testes-seguranca:canon:rastreabilidade#ligacoes_com_outros_capitulos}
