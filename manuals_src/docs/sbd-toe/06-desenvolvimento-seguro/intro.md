...
## 🧠 Enquadramento e Rationale {desenvolvimento-seguro:intro#enquadramento}
...
## 🧭 O que cobre tecnicamente {desenvolvimento-seguro:intro#o_que_cobre_tecnicamente}
...
## ⚙️ O que deve ser feito {desenvolvimento-seguro:intro#o_que}
...
## 👥 Quem está envolvido {desenvolvimento-seguro:intro#quem}
...
## ⏱️ Quando aplicar {desenvolvimento-seguro:intro#quando}
...
## 🎯 Para quê {desenvolvimento-seguro:intro#para_que}
...
## ⚖️ Proporcionalidade L1–L3 {desenvolvimento-seguro:intro#proporcionalidade}
...
Sem disciplina de desenvolvimento seguro, todos os controlos seguintes no SbD-ToE tornam-se **reativos e incompletos**.  
Este capítulo estabelece a base sobre a qual se constrói a confiança no ciclo de vida de software.
:::

---

## 📜 Políticas Organizacionais Relevantes {desenvolvimento-seguro:intro#politicas}
