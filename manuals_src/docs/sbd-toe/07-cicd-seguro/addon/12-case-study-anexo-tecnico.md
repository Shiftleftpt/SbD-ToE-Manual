...
# 📎 Anexo Técnico — Aplicação do SbD-ToE ao Pipeline CI/CD {cicd-seguro:addon:controle-excecoes-visibilidade}
...
## ✅ Checkpoints de Validação por Fase {cicd-seguro:addon:controle-excecoes-visibilidade#checkpoints_de_validacao_por_fase}
...
## 🧩 User Stories Relevantes {cicd-seguro:addon:controle-excecoes-visibilidade#user_stories_relevantes}
...
## 📜 Requisitos Aplicáveis {cicd-seguro:addon:controle-excecoes-visibilidade#requisitos_aplicaveis}
...
## 📋 Checklist Operacional {cicd-seguro:addon:controle-excecoes-visibilidade#checklist_operacional}
...
## ✅ Considerações Finais {cicd-seguro:addon:controle-excecoes-visibilidade#consideracoes_finais}
