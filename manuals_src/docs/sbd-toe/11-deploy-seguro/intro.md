...
Sem controlos de deploy seguros, não é possível garantir a integridade da passagem a produção, nem responder rapidamente a incidentes.
:::

# Deploy Seguro {cap11:intro}

## 🔎 Nota metodológica {cap11:intro#nota-metodologica}
...
## 🧭 O que cobre tecnicamente {cap11:intro#o-que-cobre}
...
## 🧪 Prescrição prática {cap11:intro#prescricao}
...
## 👥 Papéis envolvidos {cap11:intro#papeis}
...
## 📚 Alinhamento com frameworks {cap11:intro#frameworks}
...
## 📜 Políticas Organizacionais Relevantes {cap11:intro#politicas}
