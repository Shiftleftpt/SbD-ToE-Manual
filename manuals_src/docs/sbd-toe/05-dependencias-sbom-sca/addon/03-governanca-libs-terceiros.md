...
# 📄 Governaça de Bibliotecas e Componentes de Terceiros {dependencias-sbom-sca:addon:governanca-libs-terceiros}

## 🌟 Objetivo {dependencias-sbom-sca:addon:governanca-libs-terceiros#objetivo}
...
## 🔢 Princípios de governaça {dependencias-sbom-sca:addon:governanca-libs-terceiros#principios_de_governaca}
...
## 🚀 Processo de aprovação {dependencias-sbom-sca:addon:governanca-libs-terceiros#processo_de_aprovacao}
...
## 🔎 Critérios de aceitação {dependencias-sbom-sca:addon:governanca-libs-terceiros#criterios_de_aceitacao}
...
## 📝 Registo de decisões {dependencias-sbom-sca:addon:governanca-libs-terceiros#registo_de_decisoes}
...
## 🔒 Referências cruzadas {dependencias-sbom-sca:addon:governanca-libs-terceiros#referencias_cruzadas}
