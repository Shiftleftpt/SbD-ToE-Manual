    ...
    >
      ...
      <g>
        ...
        */}
        ...
        <circle cx="674" cy="220" r="30" fill="var(--ifm-background-surface-color)" stroke="var(--ifm-color-emphasis-400)" strokeWidth="2" />
        <circle cx="638" cy="464" r="30" fill="var(--ifm-background-surface-color)" stroke="var(--ifm-color-emphasis-400)" strokeWidth="2" />
        <circle cx="362" cy="464" r="30" fill="var(--ifm-background-surface-color)" stroke="var(--ifm-color-emphasis-400)" strokeWidth="2" />
        <circle cx="326" cy="220" r="30" fill="var(--ifm-background-surface-color)" stroke="var(--ifm-color-emphasis-400)" strokeWidth="2" />
        ...
        <text x="690" y="490" className="toe-title">
          Experiência "from the trenches"
        </text>
        <text x="690" y="520" className="toe-text">
          <tspan x="690" dy="0">Auditorias, post-mortems</tspan>
          <tspan x="690" dy="18">revelam o que realmente</tspan>
          <tspan x="690" dy="18">funciona no terreno.</tspan>
        </text>

        {/* SW — Ameaças & Threat Intelligence */}
        <text x="340" y="490" textAnchor="end" className="toe-title">
          Ameaças &amp; Threat Intelligence
        </text>
        <text x="340" y="520" textAnchor="end" className="toe-text">
          <tspan x="340" dy="0">Taxonomias de ataques</tspan>
          <tspan x="340" dy="18">revelam onde os sistemas</tspan>
          <tspan x="340" dy="18">falham.</tspan>
        </text>
        ...
        <text x="280" y="220" textAnchor="end" className="toe-text">
          <tspan x="280" dy="0">Preocupações normativas</tspan>
