...
# 🛡️ Enforcement Contínuo de Políticas e Regras de Segurança em IaC {iac-infraestrutura:addon:controle-enforcement}

## 🌟 Objetivo {iac-infraestrutura:addon:controle-enforcement#objetivo}
...
## 🔖 O que deve ser feito {iac-infraestrutura:addon:controle-enforcement#o_que_deve_ser_feito}
...
## ⚖️ Como deve ser feito {iac-infraestrutura:addon:controle-enforcement#como_deve_ser_feito}
...
## 🗓️ Quando aplicar {iac-infraestrutura:addon:controle-enforcement#quando_aplicar}
...
## 💼 Exemplos práticos {iac-infraestrutura:addon:controle-enforcement#exemplos_praticos}

### ✏️ Exemplo de regra Rego (OPA) {iac-infraestrutura:addon:controle-enforcement#exemplo_de_regra_rego_opa}
...
### 🌍 Integração em pipeline GitHub Actions {iac-infraestrutura:addon:controle-enforcement#integracao_em_pipeline_github_actions}
...
## 📈 Benefícios diretos {iac-infraestrutura:addon:controle-enforcement#beneficios_diretos}
