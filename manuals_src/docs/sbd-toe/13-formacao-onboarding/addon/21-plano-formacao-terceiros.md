...
# 🤝 Formação Mínima para Terceiros e Fornecedores {formacao-onboarding:addon:plano-formacao-terceiros}
...
## 🎯 Objetivo {formacao-onboarding:addon:plano-formacao-terceiros#objetivo}
...
## 🧭 Escopo de aplicação {formacao-onboarding:addon:plano-formacao-terceiros#escopo_de_aplicacao}
...
## 📋 Conteúdos mínimos obrigatórios {formacao-onboarding:addon:plano-formacao-terceiros#conteudos_minimos_obrigatorios}
...
## ✅ Validação obrigatória {formacao-onboarding:addon:plano-formacao-terceiros#validacao_obrigatoria}
...
## 🔗 Integração com processos internos {formacao-onboarding:addon:plano-formacao-terceiros#integracao_com_processos_internos}
...
## 🧩 Ligações a outros documentos {formacao-onboarding:addon:plano-formacao-terceiros#ligacoes_a_outros_documentos}
