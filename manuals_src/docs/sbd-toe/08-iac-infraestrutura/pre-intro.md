...
<a name="xref:cap08:pre-intro"></a>

# 📑 Rationale — Catálogo de Requisitos de IaC {iac-infraestrutura:pre-intro}

## 🧠 Porque este capítulo é **excecional** {iac-infraestrutura:pre-intro#porque-excecional}
...
## 🔑 Pontos fundamentais da excecionalidade {iac-infraestrutura:pre-intro#pontos-fundamentais}
...
## 📚 Fontes técnicas que fundamentam o catálogo {iac-infraestrutura:pre-intro#fontes}
...
## 🧩 Relação com o Cap. 02 — Requisitos de Segurança {iac-infraestrutura:pre-intro#relacao-cap02}
...
## 🧱 Como adaptar o catálogo organizacional {iac-infraestrutura:pre-intro#metodologia}
...
## 🧾 Porquê user stories por requisito {iac-infraestrutura:pre-intro#user-stories-por-requisito}
...
## ⚖️ Proporcionalidade L1–L3 (princípios aplicados a IaC) {iac-infraestrutura:pre-intro#proporcionalidade}
...
## 📦 Evidências esperadas {iac-infraestrutura:pre-intro#evidencias}
...
## 🚫 Anti-padrões frequentes em IaC {iac-infraestrutura:pre-intro#anti-padroes}
...
## 🏛️ Governação e métricas {iac-infraestrutura:pre-intro#governacao}
...
## 📌 Como ler este capítulo {iac-infraestrutura:pre-intro#como-ler}
