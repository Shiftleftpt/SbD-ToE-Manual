...
# 📎 Rastreabilidade contra Frameworks — Capítulo 03: Threat Modeling {threat-modeling:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {threat-modeling:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {threat-modeling:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {threat-modeling:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {threat-modeling:canon:rastreabilidade#owasp_samm_v21}
...
### 📊 BSIMM13 {threat-modeling:canon:rastreabilidade#bsimm13}
...
### 🏛️ ISO/IEC 27034 {threat-modeling:canon:rastreabilidade#isoiec_27034}
...
### 🔐 OWASP ASVS v5 {threat-modeling:canon:rastreabilidade#owasp_asvs_v5}
...
### 📐 NIST SP 800-53 {threat-modeling:canon:rastreabilidade#nist_sp_800_53}
...
### 📘 CIS Controls v8 {threat-modeling:canon:rastreabilidade#cis_controls_v8}
...
### 🔄 ENISA DevSecOps {threat-modeling:canon:rastreabilidade#enisa_devsecops}
...
---
### 🧱 OWASP DSOMM {threat-modeling:canon:rastreabilidade#owasp_dsomm}
...
## 🔗 Ligações com outros capítulos {threat-modeling:canon:rastreabilidade#ligacoes_com_outros_capitulos}
