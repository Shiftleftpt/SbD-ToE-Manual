...
- Este guia aplica-se a todos os ficheiros `intro.md`, `canon/`, `addon/` — exceto onde explicitamente justificado (ex: `addon/05-exemplos.md` pode usar estilo mais narrativo).
