...
## 🧱 Categoria 1 – Falhas de segmentação e isolamento arquitetural
...
## 🔎 Categoria 2 – Deficiências na modelação arquitetural
...
## 🧪 Categoria 3 – Validação e evolução arquitetural negligenciada
...
## 🔄 Categoria 4 – Ausência de rastreabilidade e requisitos arquiteturais
...
| Ameaça                                      | Fonte                             | Como surge                                           | Como a prática mitiga                                                              | Controlos associados                       | 🧩 Mitigada apenas por este capítulo? |
|---------------------------------------------|------------------------------------|------------------------------------------------------|-------------------------------------------------------------------------------------|--------------------------------------------|----------------------------------------|
| Aplicações L1 tratadas como críticas        | OSC&R / SSDF PW.1                 | Design arquitetural sem relação com classificação     | Validação arquitetural proporcional ao risco (ex: app L1 pode partilhar recursos)  | `15-aplicacao-lifecycle.md`         | ❌ Cap. 01                             |
