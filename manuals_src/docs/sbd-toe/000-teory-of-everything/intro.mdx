...
O **Security by Design – Theory of Everything (SbD–ToE)** é uma filosofia, um enquadramento conceptual e um modelo operativo para a engenharia de software seguro. O seu objetivo não é introduzir mais um referencial no ecossistema existente, mas **estabelecer um plano unificador** que torne o *Security by Design* **executável, governável e auditável** ao longo de todo o ciclo de vida do software — do nível normativo e estratégico ao nível do código, do pipeline e da operação.
...
- **NIST — Secure Software Development Framework (SP 800-218)**  
  ...
  O SSDF afirma explicitamente o princípio, mas não prescreve proporcionalidade ao risco, artefactos mínimos, ligação sistemática a ameaças ou governação operacional integrada do SDLC.
