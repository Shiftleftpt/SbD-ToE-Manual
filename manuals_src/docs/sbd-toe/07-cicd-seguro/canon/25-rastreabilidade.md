...
# 📎 Rastreabilidade contra Frameworks — Capítulo 07: CI/CD Seguro {cicd-seguro:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {cicd-seguro:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {cicd-seguro:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {cicd-seguro:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {cicd-seguro:canon:rastreabilidade#owasp_samm_v21}
...
### 📊 BSIMM13 {cicd-seguro:canon:rastreabilidade#bsimm13}
...
### 🔐 SLSA v1.0 {cicd-seguro:canon:rastreabilidade#slsa_v10}
...
### 🧪 DSOMM — DevSecOps Maturity Model {cicd-seguro:canon:rastreabilidade#dsomm__devsecops_maturity_model}
...
### 🏛️ ISO/IEC 27001 {cicd-seguro:canon:rastreabilidade#isoiec_27001}
...
### 📐 CIS Controls v8 {cicd-seguro:canon:rastreabilidade#cis_controls_v8}
...
### 🔄 ENISA DevSecOps {cicd-seguro:canon:rastreabilidade#enisa_devsecops}
...
## 🔗 Ligações com outros capítulos {cicd-seguro:canon:rastreabilidade#ligacoes_com_outros_capitulos}
