...
# 🎓 Trilhos Formativos por Função e Risco {formacao-onboarding:addon:trilho-formativo}

## 🌟 Objetivo {formacao-onboarding:addon:trilho-formativo#objetivo}
...
## 🧬 O que é um Trilho Formativo {formacao-onboarding:addon:trilho-formativo#o_que_e_um_trilho_formativo}
...
## 📋 Matriz Base por Perfil e Nível de Risco {formacao-onboarding:addon:trilho-formativo#matriz_base_por_perfil_e_nivel_de_risco}
...
## 🛠️ Como aplicar {formacao-onboarding:addon:trilho-formativo#como_aplicar}
...
## ✅ Boas práticas {formacao-onboarding:addon:trilho-formativo#boas_praticas}
...
## 📎 Referências cruzadas {formacao-onboarding:addon:trilho-formativo#referencias_cruzadas}
