...
title: Aplicação ao Ciclo de Vida — Containers e Execução Isolada
...
# ⚙️ Aplicação ao Ciclo de Vida — Containers e Execução Isolada {cap09:aplicacao-lifecycle}
...
## 🧭 Quando aplicar {cap09:aplicacao-lifecycle#quando-aplicar}
...
| Desenvolvimento | Construção de imagens a partir de bases confiáveis e pinadas | Mitigar risco de supply chain |
...
## 👥 Quem executa cada ação {cap09:aplicacao-lifecycle#quem-executa}
...
## 📖 User Stories Reutilizáveis {cap09:aplicacao-lifecycle#user-stories}

### US-01 – Construção de imagens seguras {#us-01}
**Contexto.**  
...
**História.**  
Como **Dev Team**, quero construir imagens a partir de bases confiáveis e pinadas, para reduzir risco de vulnerabilidades e supply chain.  
...
### US-02 – Scanning automático em CI/CD {#us-02}
**Contexto.**  
...
### US-03 – Assinatura e proveniência de imagens {#us-03}
**Contexto.**  
...
### US-04 – Políticas de execução em runtime {#us-04}
**Contexto.**  
...
### US-05 – Monitorização e resposta a incidentes {#us-05}
**Contexto.**  
...
### US-07 – Governação de registries {#us-07}
**Contexto.**  
...
### US-08 – Segredos fora da imagem {#us-08}
**Contexto.**  
...
### US-09 – RBAC mínimo e ServiceAccounts {#us-09}
**Contexto.**  
...
### US-11 – Golden Base Images {#us-11}
**Contexto.**  
...
### US-12 – Governação de builders e runners {#us-12}
**Contexto.**  
...
## 📦 Artefactos esperados {cap09:aplicacao-lifecycle#artefactos}
...
## ⚖️ Matriz de proporcionalidade L1–L3 {cap09:aplicacao-lifecycle#proporcionalidade}
...
## 🏁 Recomendações finais {cap09:aplicacao-lifecycle#recomendacoes}
