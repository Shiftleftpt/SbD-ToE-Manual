...
# 🔐 Ameaças Mitigadas — Capítulo 05: Dependências, SBOM e SCA {dependencias-sbom-sca:canon:ameacas-mitigadas}
...
## 📦 Categoria 1 – Uso de componentes vulneráveis {dependencias-sbom-sca:canon:ameacas-mitigadas#categoria_1__uso_de_componentes_vulneraveis}
...
## 🔗 Categoria 2 – Rastreabilidade e visibilidade técnica {dependencias-sbom-sca:canon:ameacas-mitigadas#categoria_2__rastreabilidade_e_visibilidade_tecnica}
...
## 🔁 Categoria 3 – Supply Chain e proveniência de artefactos {dependencias-sbom-sca:canon:ameacas-mitigadas#categoria_3__supply_chain_e_proveniencia_de_artefactos}
...
## 🚨 Categoria 4 – Falhas na gestão de exceções e aceitação de risco {dependencias-sbom-sca:canon:ameacas-mitigadas#categoria_4__falhas_na_gestao_de_excecoes_e_aceitacao_de_risco}
...
| Falta de ciclo de revisão de exceções       | NIST 800-30 / ISO 27005            | CVEs abertas por tempo indefinido                       | Ciclo de vida com reavaliação forçada por tempo ou nova versão                 | `canon/15-aplicacao-lifecycle.md`            | ❌ Cap. 01                             |

---

## 🏛️ Categoria 5 – Ausência de governação de bibliotecas e políticas de uso {dependencias-sbom-sca:canon:ameacas-mitigadas#categoria_5__ausencia_de_governacao_de_bibliotecas_e_politicas_de_uso}
...
## ✅ Conclusão {dependencias-sbom-sca:canon:ameacas-mitigadas#conclusao}
