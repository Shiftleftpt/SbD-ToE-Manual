...
Sem testes de segurança contínuos, não é possível validar se os requisitos (Cap. 02) e controlos prescritos nos capítulos anteriores estão efetivamente a funcionar.  
:::

# Testes de Segurança {cap10:intro}

## 🔎 Nota metodológica {cap10:intro#nota-metodologica}
...
## 🧭 1. O que cobre tecnicamente {cap10:intro#o_que_cobre_tecnicamente}
...
## 🧪 2. Prescrição prática {cap10:intro#prescricao}
...
## 👥 Papéis envolvidos {cap10:intro#papeis}
...
## 📚 Alinhamento com frameworks {cap10:intro#frameworks}
...
## 📜 Políticas Organizacionais Relevantes {cap10:intro#politicas}
...
## 🏁 Conclusão {cap10:intro#conclusao}
