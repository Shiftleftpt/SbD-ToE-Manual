...
# 🧪 Estudo de Caso — Aplicar o SbD-ToE ao Próprio Pipeline CI/CD {cicd-seguro:addon:controle-excecoes-visibilidade}
...
## 🧭 Contexto e decisão {cicd-seguro:addon:controle-excecoes-visibilidade#contexto_e_decisao}
...
## 📐 Arquitetura desenhada {cicd-seguro:addon:controle-excecoes-visibilidade#arquitetura_desenhada}
...
## 🔍 Threat modeling {cicd-seguro:addon:controle-excecoes-visibilidade#threat_modeling}
...
## 🛠️ Desenvolvimento seguro dos próprios pipelines {cicd-seguro:addon:controle-excecoes-visibilidade#desenvolvimento_seguro_dos_proprios_pipelines}
...
## 🧪 Testes aplicados ao pipeline {cicd-seguro:addon:controle-excecoes-visibilidade#testes_aplicados_ao_pipeline}
...
## 🔐 Gestão de dependências, imagens e SBOM {cicd-seguro:addon:controle-excecoes-visibilidade#gestao_de_dependencias_imagens_e_sbom}
...
## 📦 Deploy e execução {cicd-seguro:addon:controle-excecoes-visibilidade#deploy_e_execucao}
...
## 🎓 Formação e onboarding {cicd-seguro:addon:controle-excecoes-visibilidade#formacao_e_onboarding}
...
## 📊 Governação e visibilidade {cicd-seguro:addon:controle-excecoes-visibilidade#governacao_e_visibilidade}
...
## ✅ Conclusão {cicd-seguro:addon:controle-excecoes-visibilidade#conclusao}
