...
# 🏗️ Integração do Threat Modeling na Validação de Arquitetura {threat-modeling:addon:validacao-arquitetura}

## 🌟 Objetivo {threat-modeling:addon:validacao-arquitetura#objetivo}
...
## 📁 Artefactos a validar {threat-modeling:addon:validacao-arquitetura#artefactos_a_validar}
...
## ✅ Critérios de aceitação para validação técnica {threat-modeling:addon:validacao-arquitetura#criterios_de_aceitacao_para_validacao_tecnica}
...
## 🧭 Quando aplicar {threat-modeling:addon:validacao-arquitetura#quando_aplicar}
...
## 🔄 Integração com o ciclo de vida {threat-modeling:addon:validacao-arquitetura#integracao_com_o_ciclo_de_vida}
...
## ✅ Boas práticas {threat-modeling:addon:validacao-arquitetura#boas_praticas}
...
## 📎 Referências cruzadas {threat-modeling:addon:validacao-arquitetura#referencias_cruzadas}

| Documento                        | Relação com este ficheiro                         |
|----------------------------------|---------------------------------------------------|
| `addon/03-diagramas-ameacas.md`  | Apoio à definição dos DFDs e trust boundaries     |
| `addon/07-mapeamento-threats-requisitos.md` | Mapeamento das ameaças para requisitos formais  |
| `canon/15-aplicacao-lifecycle.md`| Integração com o ciclo de vida do desenvolvimento |
| `addon/06-threat-modeling-ci.md` | Validação automática em pipelines CI/CD           |
