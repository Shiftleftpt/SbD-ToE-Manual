...
title: Rastreabilidade com Frameworks de Segurança
...
## 🎯 Rastreabilidade com Frameworks de Referência {requisitos-seguranca:addon:rastreabilidade-frameworks#rastreabilidade_com_frameworks_de_referencia}
...
## 📘 Matriz de Mapeamento {requisitos-seguranca:addon:rastreabilidade-frameworks#matriz_de_mapeamento}
...
## 🔗 Ligação à Matriz de Aplicação por Risco {requisitos-seguranca:addon:rastreabilidade-frameworks#ligacao_a_matriz_de_aplicacao_por_risco}
...
👉 [06-matriz-controlos-por-risco.md](xref:sbd-toe:toe:01-classificacao-aplicacoes:matriz-controlos-por-risco)
...
## 📚 Utilização da Matriz {requisitos-seguranca:addon:rastreabilidade-frameworks#utilizacao_da_matriz}
