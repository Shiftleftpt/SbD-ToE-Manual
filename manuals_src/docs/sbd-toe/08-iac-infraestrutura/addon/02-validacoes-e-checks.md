...
# 🧪 Validações Automáticas e Controlo de Qualidade no Projeto IaC {iac-infraestrutura:addon:planeamento-e-controle}

## 🌟 Objetivo {iac-infraestrutura:addon:planeamento-e-controle#objetivo}
...
## 📌 O que deve ser feito {iac-infraestrutura:addon:planeamento-e-controle#o_que_deve_ser_feito}
...
## ⚙️ Como aplicar {iac-infraestrutura:addon:planeamento-e-controle#como_aplicar}
...
## 🕒 Quando aplicar {iac-infraestrutura:addon:planeamento-e-controle#quando_aplicar}
...
## 👥 Perfis envolvidos {iac-infraestrutura:addon:planeamento-e-controle#perfis_envolvidos}
...
## 🧪 Exemplos práticos {iac-infraestrutura:addon:planeamento-e-controle#exemplos_praticos}
...
## ✅ Boas práticas {iac-infraestrutura:addon:planeamento-e-controle#boas_praticas}
...
## 🔗 Referências cruzadas {iac-infraestrutura:addon:planeamento-e-controle#referencias_cruzadas}
