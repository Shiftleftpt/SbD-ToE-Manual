...
# ✅ Checklist de Revisão — Arquitetura Segura {arquitetura-segura:canon:checklist-revisao}
...
## 📋 Itens de Verificação {arquitetura-segura:canon:checklist-revisao#itens_de_verificacao}
...
## 📌 Notas de Aplicação Prática {arquitetura-segura:canon:checklist-revisao#notas_de_aplicacao_pratica}
...
## 📊 Conformidade e KPI {arquitetura-segura:canon:checklist-revisao#conformidade_e_kpi}
