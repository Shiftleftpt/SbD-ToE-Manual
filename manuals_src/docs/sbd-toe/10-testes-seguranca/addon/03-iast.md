...
# 🔬 Testes Interativos de Segurança (IAST) {testes-seguranca:addon:iast}

## 🌟 Objetivo {testes-seguranca:addon:iast#objetivo}
...
## 🔍 O que é IAST {testes-seguranca:addon:iast#o_que_e_iast}
...
## ⚙️ Como aplicar {testes-seguranca:addon:iast#como_aplicar}
...
## ✅ Boas práticas {testes-seguranca:addon:iast#boas_praticas}
...
## 📎 Referências cruzadas {testes-seguranca:addon:iast#referencias_cruzadas}
