...
# 🧱 Módulo Formativo – Infraestrutura como Código (IaC) Seguro {formacao-onboarding:addon:formacao-iac}

## 🎯 Objetivo {formacao-onboarding:addon:formacao-iac#objetivo}
...
## 📋 Pré-requisitos {formacao-onboarding:addon:formacao-iac#pre_requisitos}
...
## 🧪 Formato da sessão {formacao-onboarding:addon:formacao-iac#formato_da_sessao}
...
## 📦 Materiais necessários {formacao-onboarding:addon:formacao-iac#materiais_necessarios}
...
## ✅ Critérios de conclusão {formacao-onboarding:addon:formacao-iac#criterios_de_conclusao}
...
## 🔁 Integração no ciclo de vida {formacao-onboarding:addon:formacao-iac#integracao_no_ciclo_de_vida}
...
## 🔗 Referências cruzadas no SbD-ToE {formacao-onboarding:addon:formacao-iac#referencias_cruzadas_no_sbd_toe}
...
## 📊 Boas práticas operacionais {formacao-onboarding:addon:formacao-iac#boas_praticas_operacionais}
