...
# 🛠️ Critérios para Aceitação de Risco {classificacao-aplicacoes:addon:criterios-aceitacao-risco}
...
## 📌 Parâmetros para avaliação {classificacao-aplicacoes:addon:criterios-aceitacao-risco#parametros_para_avaliacao}
...
## ⚖️ Limiares de aceitação por nível {classificacao-aplicacoes:addon:criterios-aceitacao-risco#limiares_de_aceitacao_por_nivel}
...
## 🧾 Exemplos de critérios formais de aceitação {classificacao-aplicacoes:addon:criterios-aceitacao-risco#exemplos_de_criterios_formais_de_aceitacao}
...
## ❌ Critérios para rejeição ou mitigação obrigatória {classificacao-aplicacoes:addon:criterios-aceitacao-risco#criterios_para_rejeicao_ou_mitigacao_obrigatoria}
...
## 🏡 Processo recomendado de aceitação {classificacao-aplicacoes:addon:criterios-aceitacao-risco#processo_recomendado_de_aceitacao}
...
## 📌 Recomendações finais {classificacao-aplicacoes:addon:criterios-aceitacao-risco#recomendacoes_finais}
