...
# ⚖️ Exceções e Aceitação de Risco em Vulnerabilidades {dependencias-sbom-sca:addon:excecoes-e-aceitacao-risco}

## 🌟 Objetivo {dependencias-sbom-sca:addon:excecoes-e-aceitacao-risco#objetivo}
...
## 🔍 Quando é aceitável uma exceção {dependencias-sbom-sca:addon:excecoes-e-aceitacao-risco#quando_e_aceitavel_uma_excecao}
...
## 📋 Processo de aceitação de risco {dependencias-sbom-sca:addon:excecoes-e-aceitacao-risco#processo_de_aceitacao_de_risco}
...
## 📁 Template YAML de exceção {dependencias-sbom-sca:addon:excecoes-e-aceitacao-risco#template_yaml_de_excecao}
...
## ✅ Check de aceitação mínima {dependencias-sbom-sca:addon:excecoes-e-aceitacao-risco#check_de_aceitacao_minima}
...
## 🔗 Ligações com outros ficheiros {dependencias-sbom-sca:addon:excecoes-e-aceitacao-risco#ligacoes_com_outros_ficheiros}
