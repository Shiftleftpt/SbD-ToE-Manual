...
# 📘️ Matriz de Requisitos Técnicos para Projetos IaC {iac-infraestrutura:addon:matriz-requisitos-iac}
...
## 📊 Requisitos por nível de risco {iac-infraestrutura:addon:matriz-requisitos-iac#requisitos_por_nivel_de_risco}
...
## 📌 Notas explicativas {iac-infraestrutura:addon:matriz-requisitos-iac#notas_explicativas}
...
## 🧾 Exemplos de evidência {iac-infraestrutura:addon:matriz-requisitos-iac#exemplos_de_evidencia}
...
## 🔗 Relacionado com outros capítulos {iac-infraestrutura:addon:matriz-requisitos-iac#relacionado_com_outros_capitulos}

<!-- * [Capítulo 02 – Requisitos de Segurança (REQ-XXX)](../../02-requisitos-seguranca) -->
* [Capítulo 06 – Desenvolvimento Seguro](../../06-desenvolvimento-seguro)
* [Capítulo 07 – CI/CD Seguro](../../07-ci-cd)
* [Capítulo 11 – Deploy e Controlo de Execução](../../11-deploy)
