...
# 📘 Matriz de Requisitos Técnicos para Projetos IaC {arquitetura-segura:addon:matriz-requisitos-iac}
...
## 📊 Requisitos por nível de risco {arquitetura-segura:addon:matriz-requisitos-iac#requisitos_por_nivel_de_risco}
...
## 📎 Notas explicativas {arquitetura-segura:addon:matriz-requisitos-iac#notas_explicativas}
...
## 🧾 Exemplos de evidência {arquitetura-segura:addon:matriz-requisitos-iac#exemplos_de_evidencia}
...
## 🔗 Relacionado com outros capítulos {arquitetura-segura:addon:matriz-requisitos-iac#relacionado_com_outros_capitulos}
