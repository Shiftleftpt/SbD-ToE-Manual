...
# 🕵️ PenTesting — Validação de Segurança Ofensiva {testes-seguranca:addon:pen-testing}
...
## 🌟 Objetivo {testes-seguranca:addon:pen-testing#objetivo}
...
## 🔍 O que é PenTesting {testes-seguranca:addon:pen-testing#o_que_e_pentesting}
...
## ⚙️ Abordagens possíveis {testes-seguranca:addon:pen-testing#abordagens_possiveis}

Existem duas formas principais de conduzir um PenTest:

### ⚫ Abordagem "Caixa Negra" (*Black Box*) {testes-seguranca:addon:pen-testing#abordagem_caixa_negra_black_box}
...
### ⚪ Abordagem "Caixa Cinzenta" (*Grey Box*) {testes-seguranca:addon:pen-testing#abordagem_caixa_cinzenta_grey_box}
...
## 🔁 Integração com o Capítulo 10 {testes-seguranca:addon:pen-testing#integracao_com_o_capitulo_10}
...
### Ciclo de integração sugerido: {testes-seguranca:addon:pen-testing#ciclo_de_integracao_sugerido}
...
## 📋 Checklist de Planeamento {testes-seguranca:addon:pen-testing#checklist_de_planeamento}
...
## 📎 Diferença entre PenTest e outras validações {testes-seguranca:addon:pen-testing#diferenca_entre_pentest_e_outras_validacoes}
...
## 🔗 Referências normativas {testes-seguranca:addon:pen-testing#referencias_normativas}
...
## ✅ Conclusão {testes-seguranca:addon:pen-testing#conclusao}
