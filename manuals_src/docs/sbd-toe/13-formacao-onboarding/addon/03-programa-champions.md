...
# 🛡️ Programa de Security Champions {formacao-onboarding:addon:programa-champions}

## 🌟 Objetivo {formacao-onboarding:addon:programa-champions#objetivo}
...
## 🧬 O que é um Champion de Segurança {formacao-onboarding:addon:programa-champions#o_que_e_um_champion_de_seguranca}
...
## 👤 Perfil de um Champion {formacao-onboarding:addon:programa-champions#perfil_de_um_champion}
...
## 🛠️ Como aplicar {formacao-onboarding:addon:programa-champions#como_aplicar}

### 🏗 Estrutura do Programa {formacao-onboarding:addon:programa-champions#estrutura_do_programa}
...
### 📋 Cartão de backlog sugerido {formacao-onboarding:addon:programa-champions#cartao_de_backlog_sugerido}
...
## 🔄 Atividades típicas {formacao-onboarding:addon:programa-champions#atividades_tipicas}
...
## ✅ Boas práticas {formacao-onboarding:addon:programa-champions#boas_praticas}
...
## 📈 Indicadores de sucesso {formacao-onboarding:addon:programa-champions#indicadores_de_sucesso}
...
## 📎 Referências cruzadas {formacao-onboarding:addon:programa-champions#referencias_cruzadas}
