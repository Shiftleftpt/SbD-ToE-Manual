...
# 📈 Maturidade — Testes de Segurança {testes-seguranca:canon:maturidade}
...
## 🎯 Como interpretar este mapeamento de maturidade {testes-seguranca:canon:maturidade#como_interpretar_este_mapeamento_de_maturidade}
...
## 🧭 Visão Geral de Alinhamento {testes-seguranca:canon:maturidade#visao_geral_de_alinhamento}
...
## 🧱 OWASP SAMM – Verification → Security Testing {testes-seguranca:canon:maturidade#owasp_samm__verification__security_testing}
...
## 🧱 OWASP DSOMM – Domínios Testing + Design & Development {testes-seguranca:canon:maturidade#owasp_dsomm__dominios_testing__design__development}
...
## 🧱 NIST SSDF – Requisitos de Validação {testes-seguranca:canon:maturidade#nist_ssdf__requisitos_de_validacao}
...
## 🧱 BSIMM – Práticas Observadas em Organizações Reais {testes-seguranca:canon:maturidade#bsimm__praticas_observadas_em_organizacoes_reais}
...
## 🧱 SLSA – Build/Test Coverage {testes-seguranca:canon:maturidade#slsa__buildtest_coverage}
...
## ✅ Conclusão {testes-seguranca:canon:maturidade#conclusao}
