...
# ✅ Checklist de Revisão — Classificação da Criticidade Aplicacional {classificacao-aplicacoes:canon:checklist-revisao}
...
## 📋 Itens de Verificação {classificacao-aplicacoes:canon:checklist-revisao#itens_de_verificacao}
...
## 🔄 Notas Finais {classificacao-aplicacoes:canon:checklist-revisao#notas_finais}
