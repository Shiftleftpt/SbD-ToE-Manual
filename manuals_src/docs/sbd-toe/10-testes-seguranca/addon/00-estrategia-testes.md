...
# 🧭 Estratégia de Testes de Segurança no Ciclo de Vida {testes-seguranca:addon:intro}

## 🌟 Objetivo {testes-seguranca:addon:intro#objetivo}
...
## 🔍 O que é uma estratégia de testes de segurança {testes-seguranca:addon:intro#o_que_e_uma_estrategia_de_testes_de_seguranca}
...
## 🧬 Mapeamento SDLC → Testes {testes-seguranca:addon:intro#mapeamento_sdlc__testes}
...
## 🛠️ Como aplicar na prática {testes-seguranca:addon:intro#como_aplicar_na_pratica}
...
## ✅ Boas práticas {testes-seguranca:addon:intro#boas_praticas}
...
## 📎 Referências cruzadas {testes-seguranca:addon:intro#referencias_cruzadas}
