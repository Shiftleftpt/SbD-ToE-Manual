...
# Exemplos de Aplicação de Requisitos de Segurança {requisitos-seguranca:addon:exemplos-aplicacao}
...
## Cenário: Nova funcionalidade de upload de documentos numa aplicação web B2B {requisitos-seguranca:addon:exemplos-aplicacao#cenario_nova_funcionalidade_de_upload_de_documentos_numa_aplicacao_web_b2b}

### 🧩 1. Contexto {requisitos-seguranca:addon:exemplos-aplicacao#1_contexto}
...
### 🔎 2. Revisão da classificação de risco {requisitos-seguranca:addon:exemplos-aplicacao#2_revisao_da_classificacao_de_risco}
...
### 📝 3. Identificação dos requisitos relevantes {requisitos-seguranca:addon:exemplos-aplicacao#3_identificacao_dos_requisitos_relevantes}
...
### 🔗 4. Rastreabilidade (risco → requisito → controlo → validação) {requisitos-seguranca:addon:exemplos-aplicacao#4_rastreabilidade_risco__requisito__controlo__validacao}
...
### 👥 5. Papéis envolvidos {requisitos-seguranca:addon:exemplos-aplicacao#5_papeis_envolvidos}
...
### 📆 6. Ponto de verificação no ciclo de vida {requisitos-seguranca:addon:exemplos-aplicacao#6_ponto_de_verificacao_no_ciclo_de_vida}
...
## Conclusão {requisitos-seguranca:addon:exemplos-aplicacao#conclusao}
