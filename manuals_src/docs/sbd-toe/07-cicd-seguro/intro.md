...
## 🧠 Enquadramento e Rationale {cicd-seguro:intro#enquadramento}
...
## 🧭 O que cobre tecnicamente {cicd-seguro:intro#cobertura}
...
## 📌 O que deve ser feito {cicd-seguro:intro#oque_fazer}
...
## ⚙️ Como deve ser feito {cicd-seguro:intro#como_fazer}
...
## 📆 Quando aplicar {cicd-seguro:intro#quando}
...
## 👥 Quem está envolvido {cicd-seguro:intro#quem}
...
## 🎯 Para quê {cicd-seguro:intro#paraque}
...
## 📜 Políticas Organizacionais Relevantes {cicd-seguro:intro#politicas}
