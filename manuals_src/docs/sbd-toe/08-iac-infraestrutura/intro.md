...
## 🧠 Enquadramento e Rationale {iac-infraestrutura:intro#enquadramento}
...
## 🧭 O que cobre tecnicamente {iac-infraestrutura:intro#o_que_cobre_tecnicamente}
...
## 👥 Quem está envolvido {iac-infraestrutura:intro#quem_esta_envolvido}
...
## 🎯 Para quê {iac-infraestrutura:intro#para_que}
...
## 📜 Políticas Organizacionais Relevantes {iac-infraestrutura:intro#politicas}
