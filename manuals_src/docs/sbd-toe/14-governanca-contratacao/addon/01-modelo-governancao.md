...
# 🧱 Modelo de Governação para Security by Design {governanca-contratacao:addon:modelo-governancao}

## 🌟 Objetivo {governanca-contratacao:addon:modelo-governancao#objetivo}
...
## 👥 Papéis e responsabilidades {governanca-contratacao:addon:modelo-governancao#papeis_e_responsabilidades}
...
## 🛠️ Como aplicar {governanca-contratacao:addon:modelo-governancao#como_aplicar}

### 📌 Decisões típicas com governação formal {governanca-contratacao:addon:modelo-governancao#decisoes_tipicas_com_governacao_formal}
...
### 🗂️ Evidência e rastreabilidade {governanca-contratacao:addon:modelo-governancao#evidencia_e_rastreabilidade}
...
## 🔁 Ciclo típico de governação {governanca-contratacao:addon:modelo-governancao#ciclo_tipico_de_governacao}
...
## 📄 Documentação recomendada {governanca-contratacao:addon:modelo-governancao#documentacao_recomendada}
...
## ✅ Boas práticas {governanca-contratacao:addon:modelo-governancao#boas_praticas}
...
## 🔗 Referências cruzadas {governanca-contratacao:addon:modelo-governancao#referencias_cruzadas}
...
## 📚 Alinhamento com frameworks {governanca-contratacao:addon:modelo-governancao#alinhamento_com_frameworks}
