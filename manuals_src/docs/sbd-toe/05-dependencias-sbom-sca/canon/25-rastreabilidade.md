...
# 📎 Rastreabilidade contra Frameworks — Capítulo 05: Dependências, SBOM e SCA {dependencias-sbom-sca:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {dependencias-sbom-sca:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {dependencias-sbom-sca:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {dependencias-sbom-sca:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM {dependencias-sbom-sca:canon:rastreabilidade#owasp_samm}
...
### 📊 BSIMM13 {dependencias-sbom-sca:canon:rastreabilidade#bsimm13}
...
### 🔐 SLSA v1.0 {dependencias-sbom-sca:canon:rastreabilidade#slsa_v10}
...
### 📦 OWASP DSOMM {dependencias-sbom-sca:canon:rastreabilidade#owasp_dsomm}
...
### 🏛️ ISO/IEC 27001 {dependencias-sbom-sca:canon:rastreabilidade#isoiec_27001}
...
### 📐 CIS Controls v8 {dependencias-sbom-sca:canon:rastreabilidade#cis_controls_v8}
...
### 🔄 ENISA DevSecOps {dependencias-sbom-sca:canon:rastreabilidade#enisa_devsecops}
...
## 🔗 Ligações com outros capítulos {dependencias-sbom-sca:canon:rastreabilidade#ligacoes_com_outros_capitulos}
