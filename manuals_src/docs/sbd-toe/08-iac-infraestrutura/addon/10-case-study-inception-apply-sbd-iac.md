...
# 🧪 Estudo de Caso — Aplicar o SbD-ToE a um Projeto de IaC {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac}
...
## 🧭 Classificação de risco {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#classificacao_de_risco}
...
## 📐 Arquitetura e modelo de repositório {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#arquitetura_e_modelo_de_repositorio}
...
## 🔍 Threat modeling {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#threat_modeling}
...
## 🧱 Aplicação dos requisitos de segurança {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#aplicacao_dos_requisitos_de_seguranca}
...
## 📊 Validações e evidência {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#validacoes_e_evidencia}
...
## 🔐 Integração com pipeline CI/CD {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#integracao_com_pipeline_cicd}
...
## 🎓 Formação e onboarding {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#formacao_e_onboarding}
...
## ✅ Conclusão {iac-infraestrutura:addon:case-study-inception-apply-sbd-iac#conclusao}
