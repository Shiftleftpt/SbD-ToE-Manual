...
# 🛡️ Governação de Módulos Reutilizáveis em IaC {iac-infraestrutura:addon:governanca-modulos}

## 🌟 Objetivo {iac-infraestrutura:addon:governanca-modulos#objetivo}
...
## 📌 O que deve ser feito {iac-infraestrutura:addon:governanca-modulos#o_que_deve_ser_feito}
...
## ⚙️ Como aplicar {iac-infraestrutura:addon:governanca-modulos#como_aplicar}
...
## 🕒 Quando aplicar {iac-infraestrutura:addon:governanca-modulos#quando_aplicar}
...
## 👥 Perfis envolvidos {iac-infraestrutura:addon:governanca-modulos#perfis_envolvidos}
...
## 🧪 Exemplos práticos {iac-infraestrutura:addon:governanca-modulos#exemplos_praticos}
...
## ✅ Boas práticas {iac-infraestrutura:addon:governanca-modulos#boas_praticas}
...
## 🔗 Referências cruzadas {iac-infraestrutura:addon:governanca-modulos#referencias_cruzadas}
