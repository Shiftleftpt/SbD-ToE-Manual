...
# 🧭 Domínios e Abrangência da Monitorização {monitorizacao-operacoes:addon:dominios-monitorizacao}

## 🌟 Objetivo {monitorizacao-operacoes:addon:dominios-monitorizacao#objetivo}
...
## 🧬 O que são domínios de monitorização {monitorizacao-operacoes:addon:dominios-monitorizacao#o_que_sao_dominios_de_monitorizacao}
...
## 🗂️ Tipos de monitorização {monitorizacao-operacoes:addon:dominios-monitorizacao#tipos_de_monitorizacao}
...
## 🔎 Como aplicar {monitorizacao-operacoes:addon:dominios-monitorizacao#como_aplicar}
...
## 📘 Fontes típicas de dados para cada domínio {monitorizacao-operacoes:addon:dominios-monitorizacao#fontes_tipicas_de_dados_para_cada_dominio}
...
## 📊 Proporcionalidade por nível de risco {monitorizacao-operacoes:addon:dominios-monitorizacao#proporcionalidade_por_nivel_de_risco}
...
## ✅ Boas práticas {monitorizacao-operacoes:addon:dominios-monitorizacao#boas_praticas}
...
## 📎 Referências cruzadas {monitorizacao-operacoes:addon:dominios-monitorizacao#referencias_cruzadas}
