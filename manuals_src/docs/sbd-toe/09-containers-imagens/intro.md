...
A sua não aplicação **inviabiliza a confiança na execução segura de pipelines, aplicações e ambientes containerizados**.  
Sem controlo de execução, não há segurança de runtime.
:::

# Containers e Execução Isolada {cap09:intro}

## 🧠 Enquadramento e Rationale {cap09:intro#enquadramento_e_rationale}
...
## 🔎 Nota metodológica {cap09:intro#nota-metodologica}
...
## 🧭 O que cobre tecnicamente {cap09:intro#o_que_cobre_tecnicamente}
...
- Escolha e validação de imagens base seguras e pinadas.  
...
## 🧪 Pilares de governação {cap09:intro#pilares}
...
## ⚙️ Como deve ser feito {cap09:intro#como_deve_ser_feito}
...
## 📆 Quando aplicar {cap09:intro#quando_aplicar}
...
## 👥 Quem está envolvido {cap09:intro#quem_esta_envolvido}
...
## 🧮 Aplicação proporcional L1–L3 {cap09:intro#proporcionalidade}
...
## 📜 Políticas Organizacionais Relevantes {cap09:intro#politicas}
