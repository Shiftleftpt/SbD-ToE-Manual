...
title: Políticas Organizacionais — Formação e Onboarding Seguro
sidebar_position: 60
---

# 🏛️ Políticas Organizacionais — Formação e Onboarding Seguro {formacao-onboarding:canon:policies-relevantes}
...
## 📌 Nota fundamental {formacao-onboarding:canon:policies-relevantes#nota_fundamental}

> ✅ A formação deve ser tratada como um **controlo de segurança obrigatório**, não como uma opção ou formalidade.

---

## 🧾 Políticas recomendadas {formacao-onboarding:canon:policies-relevantes#politicas_recomendadas}
...
## 📚 Referências normativas associadas {formacao-onboarding:canon:policies-relevantes#referencias_normativas_associadas}
...
## ✅ Recomendações finais {formacao-onboarding:canon:policies-relevantes#recomendacoes_finais}
