...
# 📊 KPIs de Governança e Visibilidade Organizacional {governanca-contratacao:canon:kpis-governanca}
...
## 📅 1. KPIs operacionais (por projeto ou aplicação) {governanca-contratacao:canon:kpis-governanca#1_kpis_operacionais_por_projeto_ou_aplicacao}
...
## 🔁 2. KPIs de processo (organizacionais) {governanca-contratacao:canon:kpis-governanca#2_kpis_de_processo_organizacionais}
...
## 📈 3. KPIs estratégicos (resumo executivo) {governanca-contratacao:canon:kpis-governanca#3_kpis_estrategicos_resumo_executivo}
...
## ✅ Recomendações {governanca-contratacao:canon:kpis-governanca#recomendacoes}
...
## 🔗 Ligações cruzadas {governanca-contratacao:canon:kpis-governanca#ligacoes_cruzadas}
