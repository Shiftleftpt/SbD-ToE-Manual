...
# 📈 Maturidade — CI/CD Seguro {cicd-seguro:canon:maturidade}
...
## 🎯 Como interpretar este mapeamento de maturidade {cicd-seguro:canon:maturidade#como_interpretar_este_mapeamento_de_maturidade}
...
## 🧭 Visão Geral de Alinhamento {cicd-seguro:canon:maturidade#visao_geral_de_alinhamento}
...
## 🧱 OWASP SAMM – Build & Deployment Automation {cicd-seguro:canon:maturidade#owasp_samm__build__deployment_automation}
...
## 🧱 OWASP DSOMM – Build, Test, Release, Operate {cicd-seguro:canon:maturidade#owasp_dsomm__build_test_release_operate}
...
## 🧱 NIST SSDF – Pipeline e Proveniência {cicd-seguro:canon:maturidade#nist_ssdf__pipeline_e_proveniencia}
...
## 🧱 BSIMM – Software Environment, Compliance {cicd-seguro:canon:maturidade#bsimm__software_environment_compliance}
...
## 🧱 SLSA – Provenance & CI/CD Control {cicd-seguro:canon:maturidade#slsa__provenance__cicd_control}
...
## ✅ Conclusão {cicd-seguro:canon:maturidade#conclusao}
