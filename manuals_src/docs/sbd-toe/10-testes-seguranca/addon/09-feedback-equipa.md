...
# 🤝 Feedback à Equipa sobre Resultados de Segurança {testes-seguranca:addon:feedback-equipa}

## 🌟 Objetivo {testes-seguranca:addon:feedback-equipa#objetivo}
...
## 🔍 O que significa “dar feedback à equipa” {testes-seguranca:addon:feedback-equipa#o_que_significa_dar_feedback_a_equipa}
...
## ⚙️ Como aplicar {testes-seguranca:addon:feedback-equipa#como_aplicar}
...
## ✅ Boas práticas {testes-seguranca:addon:feedback-equipa#boas_praticas}
...
## 📎 Referências cruzadas {testes-seguranca:addon:feedback-equipa#referencias_cruzadas}
