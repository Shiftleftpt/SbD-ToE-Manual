...
# 🧨 Deteção e Tratamento de Vulnerabilidades em Imagens {containers-imagens:addon:vulnerabilidades-imagens}

## 🌟 Objetivo {containers-imagens:addon:vulnerabilidades-imagens#objetivo}
...
## 🧬 O que são vulnerabilidades em imagens {containers-imagens:addon:vulnerabilidades-imagens#o_que_sao_vulnerabilidades_em_imagens}
...
## 📘 Ferramentas de análise (SCA para *containers*) {containers-imagens:addon:vulnerabilidades-imagens#ferramentas_de_analise_sca_para_containers}
...
## 🛠️ Como aplicar a validação {containers-imagens:addon:vulnerabilidades-imagens#como_aplicar_a_validacao}
...
## 📂 Onde configurar e armazenar resultados {containers-imagens:addon:vulnerabilidades-imagens#onde_configurar_e_armazenar_resultados}
...
## ✅ Boas práticas {containers-imagens:addon:vulnerabilidades-imagens#boas_praticas}
...
## 📎 Referências cruzadas {containers-imagens:addon:vulnerabilidades-imagens#referencias_cruzadas}
...
| `10-maturidade.md`              | Deteção automatizada é critério de maturidade  |
