...
# 🔏 Assinatura de Imagens e Cadeia de Confiança {containers-imagens:addon:assinatura-cadeia-trust}

## 🌟 Objetivo {containers-imagens:addon:assinatura-cadeia-trust#objetivo}
...
## 🧬 O que é a cadeia de confiança em imagens {containers-imagens:addon:assinatura-cadeia-trust#o_que_e_a_cadeia_de_confianca_em_imagens}
...
## 📘 Ferramentas e mecanismos recomendados {containers-imagens:addon:assinatura-cadeia-trust#ferramentas_e_mecanismos_recomendados}
...
## 🛠️ Como aplicar assinatura e validação {containers-imagens:addon:assinatura-cadeia-trust#como_aplicar_assinatura_e_validacao}
...
## 📂 Onde armazenar e como versionar {containers-imagens:addon:assinatura-cadeia-trust#onde_armazenar_e_como_versionar}
...
## ✅ Boas práticas {containers-imagens:addon:assinatura-cadeia-trust#boas_praticas}
...
## 📎 Referências cruzadas {containers-imagens:addon:assinatura-cadeia-trust#referencias_cruzadas}
...
| `10-maturidade.md`              | Assinatura é critério de maturidade elevada    |
