...
title: Aplicação no Ciclo de Vida — Formação e Capacitação
...
# 🎓 Aplicação de Formação e Capacitação no Ciclo de Vida {cap13:aplicacao-lifecycle}

## 🧭 Quando aplicar {cap13:aplicacao-lifecycle#quando-aplicar}
...
## 👥 Quem executa cada ação {cap13:aplicacao-lifecycle#quem-executa}
...
## 📖 User Stories normalizadas {cap13:aplicacao-lifecycle#user-stories}

### US-01 — Onboarding seguro obrigatório {#us-01}
...
### US-02 — Formação contínua por perfil {#us-02}
...
### US-03 — Programa de Security Champions {#us-03}
...
**Artefactos.** Registos de reuniões  
...
### US-04 — Exercícios práticos e simulações {#us-04}
...
### US-05 — Medição de eficácia da formação {#us-05}
...
## 📦 Artefactos esperados {cap13:aplicacao-lifecycle#artefactos}
...
## ⚖️ Matriz de proporcionalidade L1–L3 {cap13:aplicacao-lifecycle#proporcionalidade}
...
## 🏁 Recomendações finais {cap13:aplicacao-lifecycle#recomendacoes}
