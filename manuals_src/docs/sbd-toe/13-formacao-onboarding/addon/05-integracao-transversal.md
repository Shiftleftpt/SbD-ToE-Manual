...
# 🔄 Integração Transversal com os Capítulos Técnicos {formacao-onboarding:addon:integracao-transversal}

## 🌟 Objetivo {formacao-onboarding:addon:integracao-transversal#objetivo}
...
## 🧬 Princípios da aprendizagem transversal {formacao-onboarding:addon:integracao-transversal#principios_da_aprendizagem_transversal}
...
## 📘 Exemplos de integração por capítulo {formacao-onboarding:addon:integracao-transversal#exemplos_de_integracao_por_capitulo}

### 1. Gestão de Risco {formacao-onboarding:addon:integracao-transversal#1_gestao_de_risco}
...
### 2. Requisitos de Segurança {formacao-onboarding:addon:integracao-transversal#2_requisitos_de_seguranca}
...
### 3. Threat Modeling {formacao-onboarding:addon:integracao-transversal#3_threat_modeling}
...
### 4. Arquitetura Segura {formacao-onboarding:addon:integracao-transversal#4_arquitetura_segura}
...
### 5. Controlo de Dependências {formacao-onboarding:addon:integracao-transversal#5_controlo_de_dependencias}
...
### 6. Desenvolvimento Seguro {formacao-onboarding:addon:integracao-transversal#6_desenvolvimento_seguro}
...
### 7. CI/CD Seguro {formacao-onboarding:addon:integracao-transversal#7_cicd_seguro}
...
### 8. IaC Seguro {formacao-onboarding:addon:integracao-transversal#8_iac_seguro}
...
### 9. *containers* e Imagens {formacao-onboarding:addon:integracao-transversal#9_containers_e_imagens}
...
### 10. Testes de Segurança {formacao-onboarding:addon:integracao-transversal#10_testes_de_seguranca}
...
### 11. Deploy Seguro {formacao-onboarding:addon:integracao-transversal#11_deploy_seguro}
...
### 12. Monitorização {formacao-onboarding:addon:integracao-transversal#12_monitorizacao}
...
### 13. Formação e Onboarding {formacao-onboarding:addon:integracao-transversal#13_formacao_e_onboarding}
...
### 14. Governança e Contratação {formacao-onboarding:addon:integracao-transversal#14_governanca_e_contratacao}
...
## ✅ Boas práticas {formacao-onboarding:addon:integracao-transversal#boas_praticas}
...
## 📎 Referências cruzadas {formacao-onboarding:addon:integracao-transversal#referencias_cruzadas}
