...
# 🏷️ Anotações e Evidência de Validações {desenvolvimento-seguro:addon:anotacoes-evidencia}
...
## 📌 Objetivos {desenvolvimento-seguro:addon:anotacoes-evidencia#objetivos}
...
## 👥 Quem deve aplicar {desenvolvimento-seguro:addon:anotacoes-evidencia#quem_deve_aplicar}
...
## ⏱️ Quando aplicar {desenvolvimento-seguro:addon:anotacoes-evidencia#quando_aplicar}
...
## 🧱 Boas práticas de anotação {desenvolvimento-seguro:addon:anotacoes-evidencia#boas_praticas_de_anotacao}
...
## ✅ Como validar {desenvolvimento-seguro:addon:anotacoes-evidencia#como_validar}
...
## 🧾 Como evidenciar {desenvolvimento-seguro:addon:anotacoes-evidencia#como_evidenciar}
...
## 🔄 Ligação a outras práticas {desenvolvimento-seguro:addon:anotacoes-evidencia#ligacao_a_outras_praticas}
