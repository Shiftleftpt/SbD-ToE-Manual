...
# 🏛️ Aplicação de Arquitetura Segura no Ciclo de Vida {arquitetura:aplicacao-lifecycle}
...
## 🧭 Quando aplicar Arquitetura Segura {arquitetura:aplicacao-lifecycle#quando_aplicar}
...
## 👥 Quem faz o quê {arquitetura:aplicacao-lifecycle#quem_faz_o_que}
...
## 📝 User Stories Reutilizáveis {arquitetura:aplicacao-lifecycle#user_stories}

### US-01 – Definição de princípios de arquitetura segura {#us-01}
**Contexto.**  
...
**Artefactos.** `principios-arquitetura.md`
...
**Ligações úteis.**
- 🔗 [Cap. 2 – Requisitos de Segurança](xref:sbd-toe:toe:02-requisitos-seguranca:intro)

---

### US-02 – Ficha de arquitetura com controlos {#us-02}
**Contexto.**  
...
**Artefactos.** `solution-architecture.md`
...
**Ligações úteis.**
- 🔗 [Cap. 4 – Catálogo de Requisitos Arquiteturais](xref:sbd-toe:toe:04-arquitetura-segura:catalogo)

---

### US-03 – Revisão de arquitetura {#us-03}
**Contexto.**  
...
**Artefactos.** `review-arquitetura.md`
...
**Ligações úteis.**
- 🔗 [Cap. 3 – Threat Modeling](xref:sbd-toe:toe:03-threat-modeling:intro)

---

### US-04 – Atualização de arquitetura em alterações críticas {#us-04}
**Contexto.**  
...
**Artefactos.** `arquitetura-atualizada.md`
...
### US-05 – Validação arquitetural em CI/CD {#us-05}
**Contexto.**  
...
**Ligações úteis.**
- 🔗 [Cap. 5 – Dependências e SCA](xref:sbd-toe:toe:05-dependencias:intro)

---

### US-06 – Validação de impacto no negócio {#us-06}
**Contexto.**  
...
**Artefactos.** `impacto-arquitetura.md`
...
**Ligações úteis.**
- 🔗 [Cap. 1 – Gestão de Risco](xref:sbd-toe:toe:01-gestao-risco:intro)

---

### US-07 – Validação arquitetural no Go-live {#us-07}
**Contexto.**  
...
**Artefactos.** `checklist-arquitetura.md`
...
**Ligações úteis.**
- 🔗 [Cap. 4 – Critérios de Validação Arquitetural](xref:sbd-toe:toe:04-arquitetura-segura:05-validacao)

---

## 📑 Artefactos Esperados {arquitetura:aplicacao-lifecycle#artefactos}
...
## 📊 Matriz de Proporcionalidade L1–L3 {arquitetura:aplicacao-lifecycle#proporcionalidade}
...
## 📌 Recomendações Finais {arquitetura:aplicacao-lifecycle#recomendacoes}
