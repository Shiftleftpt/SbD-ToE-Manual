...
# 👥 Manual de Formação por Perfil {formacao-onboarding:addon:manual-formacao-capitulos}

## 🌟 Objetivo {formacao-onboarding:addon:manual-formacao-capitulos#objetivo}
...
## 🧬 Conteúdos sugeridos por função {formacao-onboarding:addon:manual-formacao-capitulos#conteudos_sugeridos_por_funcao}

### 👤 Dev (Desenvolvedores) {formacao-onboarding:addon:manual-formacao-capitulos#dev_desenvolvedores}
...
### 👤 QA (Testers / Quality Assurance) {formacao-onboarding:addon:manual-formacao-capitulos#qa_testers__quality_assurance}
...
### 👤 PO (Product Owners) {formacao-onboarding:addon:manual-formacao-capitulos#po_product_owners}
...
### 👤 DevOps / Engenharia de Plataforma {formacao-onboarding:addon:manual-formacao-capitulos#devops__engenharia_de_plataforma}
...
### 👤 AppSec (Segurança Aplicacional) {formacao-onboarding:addon:manual-formacao-capitulos#appsec_seguranca_aplicacional}
...
### 👤 Gestão (Team Leads, Executivos, Segurança Organizacional) {formacao-onboarding:addon:manual-formacao-capitulos#gestao_team_leads_executivos_seguranca_organizacional}
...
## ✅ Boas práticas {formacao-onboarding:addon:manual-formacao-capitulos#boas_praticas}
...
## 📎 Referências cruzadas {formacao-onboarding:addon:manual-formacao-capitulos#referencias_cruzadas}
