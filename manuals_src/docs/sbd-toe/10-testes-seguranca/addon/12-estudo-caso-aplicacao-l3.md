...
# 🔪  Aplicacao Prática das Prescrições SbD-ToE numa Aplicação L3 {testes-seguranca:addon:estudo-caso}
...
## 👨‍💻 Desenvolvimento com qualidade embutida (Cap. 06) {testes-seguranca:addon:estudo-caso#desenvolvimento_com_qualidade_embutida_cap_06}
...
## 🔍 Validações automáticas no Pull Request (Cap. 10, Cap. 07) {testes-seguranca:addon:estudo-caso#validacoes_automaticas_no_pull_request_cap_10_cap_07}
...
## 🗒️ Gestão de Findings (Cap. 10, Cap. 05) {testes-seguranca:addon:estudo-caso#gestao_de_findings_cap_10_cap_05}
...
## ⚠️ Ambiente de staging e testes ofensivos (Cap. 10, Cap. 11) {testes-seguranca:addon:estudo-caso#ambiente_de_staging_e_testes_ofensivos_cap_10_cap_11}
...
## 🛡️ Monitorização e resposta contínua (Cap. 12 + Cap. 05) {testes-seguranca:addon:estudo-caso#monitorizacao_e_resposta_continua_cap_12__cap_05}
...
## 📦 Validação final antes do release (Cap. 11) {testes-seguranca:addon:estudo-caso#validacao_final_antes_do_release_cap_11}
...
## 📈 Conclusão {testes-seguranca:addon:estudo-caso#conclusao}
