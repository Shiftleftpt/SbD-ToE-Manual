...
# 🧪 Validações de segurança integradas no pipeline {cicd-seguro:addon:validacoes-seguranca-integradas}
...
## 🎯 Objetivos {cicd-seguro:addon:validacoes-seguranca-integradas#objetivos}
...
## 🛠️ Práticas {cicd-seguro:addon:validacoes-seguranca-integradas#praticas}
...
## ⚖️ Aplicação proporcional por nível de risco {cicd-seguro:addon:validacoes-seguranca-integradas#aplicacao_proporcional_por_nivel_de_risco}
...
## 📌 Exemplos práticos {cicd-seguro:addon:validacoes-seguranca-integradas#exemplos_praticos}
...
## 📉 Riscos mitigados {cicd-seguro:addon:validacoes-seguranca-integradas#riscos_mitigados}
...
## 🧭 Referências {cicd-seguro:addon:validacoes-seguranca-integradas#referencias}
