...
# 📦 Inventário de Dependências e SBOM {dependencias-sbom-sca:addon:inventario-sbom}

## 🌟 Objetivo {dependencias-sbom-sca:addon:inventario-sbom#objetivo}
...
## 🧬 O que é um SBOM {dependencias-sbom-sca:addon:inventario-sbom#o_que_e_um_sbom}
...
## 📘 Formatos suportados {dependencias-sbom-sca:addon:inventario-sbom#formatos_suportados}
...
## 🛠️ Como gerar SBOMs {dependencias-sbom-sca:addon:inventario-sbom#como_gerar_sboms}
...
## 📂 Onde armazenar SBOMs {dependencias-sbom-sca:addon:inventario-sbom#onde_armazenar_sboms}
...
## 🧬 Exemplos de campos num SBOM CycloneDX {dependencias-sbom-sca:addon:inventario-sbom#exemplos_de_campos_num_sbom_cyclonedx}
...
## ✅ Boas práticas {dependencias-sbom-sca:addon:inventario-sbom#boas_praticas}
...
## 📎 Referências cruzadas {dependencias-sbom-sca:addon:inventario-sbom#referencias_cruzadas}
