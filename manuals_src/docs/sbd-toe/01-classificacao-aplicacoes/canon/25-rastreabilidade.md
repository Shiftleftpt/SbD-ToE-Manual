...
# 📎 Rastreabilidade contra Frameworks — Capítulo 01: Classificação do Risco {classificacao-aplicacoes:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {classificacao-aplicacoes:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {classificacao-aplicacoes:canon:rastreabilidade#notas_explicativas_por_framework}

### 🛠️ NIST SSDF {classificacao-aplicacoes:canon:rastreabilidade#nist_ssdf}
...
### 🧱 OWASP SAMM v2.1 {classificacao-aplicacoes:canon:rastreabilidade#owasp_samm_v21}
...
### 🧭 OWASP DSOMM {classificacao-aplicacoes:canon:rastreabilidade#owasp_dsomm}
...
### 📊 BSIMM13 {classificacao-aplicacoes:canon:rastreabilidade#bsimm13}
...
### 🏛️ ISO/IEC 27001 {classificacao-aplicacoes:canon:rastreabilidade#isoiec_27001}
...
### 📐 CIS Controls v8 {classificacao-aplicacoes:canon:rastreabilidade#cis_controls_v8}
...
### 🔄 ENISA SDLC / Risk {classificacao-aplicacoes:canon:rastreabilidade#enisa_sdlc__risk}
...
## 🔗 Ligações com outros capítulos {classificacao-aplicacoes:canon:rastreabilidade#ligacoes_com_outros_capitulos}
