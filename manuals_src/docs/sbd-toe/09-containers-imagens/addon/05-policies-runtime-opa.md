...
# 📜 Enforcement de Políticas no Runtime com OPA e Kyverno {containers-imagens:addon:policies-runtime-opa}

## 🌟 Objetivo {containers-imagens:addon:policies-runtime-opa#objetivo}
...
## 🧬 O que são políticas de execução {containers-imagens:addon:policies-runtime-opa#o_que_sao_politicas_de_execucao}
...
## 📘 Ferramentas recomendadas {containers-imagens:addon:policies-runtime-opa#ferramentas_recomendadas}
...
## 🛠️ Como aplicar políticas no runtime {containers-imagens:addon:policies-runtime-opa#como_aplicar_politicas_no_runtime}
...
## 📂 Onde manter políticas e como versionar {containers-imagens:addon:policies-runtime-opa#onde_manter_politicas_e_como_versionar}
...
## ✅ Boas práticas {containers-imagens:addon:policies-runtime-opa#boas_praticas}
...
## 📎 Referências cruzadas {containers-imagens:addon:policies-runtime-opa#referencias_cruzadas}
...
| `10-maturidade.md`              | Políticas automáticas são critério de maturidade avançada |
