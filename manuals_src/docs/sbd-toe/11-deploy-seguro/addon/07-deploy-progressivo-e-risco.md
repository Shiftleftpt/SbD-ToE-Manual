...
# 🚀 Deploy Progressivo e Avaliação de Risco {deploy-seguro:addon:07-deploy-progressivo-e-risco}
...
## 🔄 Modelos comuns de deploy progressivo {deploy-seguro:addon:07-deploy-progressivo-e-risco#modelos_comuns_de_deploy_progressivo}
...
## 🚨 Avaliação de risco em releases progressivas {deploy-seguro:addon:07-deploy-progressivo-e-risco#avaliacao_de_risco_em_releases_progressivas}
...
## 🌐 Controlo do rollout {deploy-seguro:addon:07-deploy-progressivo-e-risco#controlo_do_rollout}
...
## 🔹 Integração com pipelines {deploy-seguro:addon:07-deploy-progressivo-e-risco#integracao_com_pipelines}
...
## 👨‍💻 Equipa responsável pelo rollout {deploy-seguro:addon:07-deploy-progressivo-e-risco#equipa_responsavel_pelo_rollout}
...
## ✅ Checklist de rollout seguro {deploy-seguro:addon:07-deploy-progressivo-e-risco#checklist_de_rollout_seguro}
