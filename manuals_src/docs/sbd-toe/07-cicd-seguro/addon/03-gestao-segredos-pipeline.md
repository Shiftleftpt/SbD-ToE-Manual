...
# 🔐 Gestão e injeção segura de segredos {cicd-seguro:addon:gestao-segredos-pipeline}
...
## 🎯 Objetivos {cicd-seguro:addon:gestao-segredos-pipeline#objetivos}
...
## 🛠️ Práticas {cicd-seguro:addon:gestao-segredos-pipeline#praticas}
...
## ⚖️ Aplicação proporcional por nível de risco {cicd-seguro:addon:gestao-segredos-pipeline#aplicacao_proporcional_por_nivel_de_risco}
...
## 📌 Exemplos práticos {cicd-seguro:addon:gestao-segredos-pipeline#exemplos_praticos}
...
## 📉 Riscos mitigados {cicd-seguro:addon:gestao-segredos-pipeline#riscos_mitigados}
...
## 🧭 Referências {cicd-seguro:addon:gestao-segredos-pipeline#referencias}
