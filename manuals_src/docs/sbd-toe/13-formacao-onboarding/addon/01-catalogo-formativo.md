...
# 🗺️ Catálogo de Conteúdos Formativos SbD-ToE {formacao-onboarding:addon:catalogo-formativo}

## 🌟 Objetivo {formacao-onboarding:addon:catalogo-formativo#objetivo}
...
## 🧬 O que contém {formacao-onboarding:addon:catalogo-formativo#o_que_contem}
...
## 📋 Estrutura da Tabela {formacao-onboarding:addon:catalogo-formativo#estrutura_da_tabela}
...
## 📘 Mapa por Capítulo {formacao-onboarding:addon:catalogo-formativo#mapa_por_capitulo}
...
## 🛠️ Como aplicar {formacao-onboarding:addon:catalogo-formativo#como_aplicar}
...
## ✅ Boas práticas {formacao-onboarding:addon:catalogo-formativo#boas_praticas}
...
## 📎 Referências cruzadas {formacao-onboarding:addon:catalogo-formativo#referencias_cruzadas}
