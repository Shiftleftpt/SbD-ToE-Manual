...
# 🧩 Mapeamento de Ameaças para Requisitos de Segurança {threat-modeling:addon:mapeamento-threats-requisitos}

## 🌟 Objetivo {threat-modeling:addon:mapeamento-threats-requisitos#objetivo}
...
## 🧭 Como mapear ameaças a requisitos {threat-modeling:addon:mapeamento-threats-requisitos#como_mapear_ameacas_a_requisitos}
...
## ✅ Exemplos de requisitos derivados {threat-modeling:addon:mapeamento-threats-requisitos#exemplos_de_requisitos_derivados}
...
## 🔗 Integração com o processo de validação {threat-modeling:addon:mapeamento-threats-requisitos#integracao_com_o_processo_de_validacao}
...
## 📁 Organização sugerida {threat-modeling:addon:mapeamento-threats-requisitos#organizacao_sugerida}
...
## ✅ Boas práticas {threat-modeling:addon:mapeamento-threats-requisitos#boas_praticas}
...
## 📎 Referências cruzadas {threat-modeling:addon:mapeamento-threats-requisitos#referencias_cruzadas}

| Documento                        | Relação com este ficheiro                            |
|----------------------------------|------------------------------------------------------|
| `addon/06-threat-modeling-ci.md` | Validação automatizada do modelo em pipelines CI/CD |
| `canon/25-rastreabilidade.md`    | Rastreabilidade top-down com frameworks e requisitos |
| `addon/01-metodologia-base.md`   | Princípios gerais de threat modeling no SbD-ToE     |
