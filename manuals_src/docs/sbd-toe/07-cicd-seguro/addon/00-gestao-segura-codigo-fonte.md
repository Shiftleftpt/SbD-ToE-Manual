...
# 📁 Gestão segura de código fonte {cicd-seguro:addon:gestao-codigo-fonte}
...
## 🎯 Objetivos {cicd-seguro:addon:gestao-codigo-fonte#objetivos}
...
## 🛠️ Práticas {cicd-seguro:addon:gestao-codigo-fonte#praticas}
...
## ⚖️ Aplicação proporcional por nível de risco {cicd-seguro:addon:gestao-codigo-fonte#aplicacao_proporcional_por_nivel_de_risco}
...
## 📌 Exemplos práticos {cicd-seguro:addon:gestao-codigo-fonte#exemplos_praticos}
...
## 📉 Riscos mitigados {cicd-seguro:addon:gestao-codigo-fonte#riscos_mitigados}
...
## 🧭 Referências {cicd-seguro:addon:gestao-codigo-fonte#referencias}
