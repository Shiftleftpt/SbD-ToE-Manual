...
# 📎 Rastreabilidade contra Frameworks — Capítulo 11: Deploy Seguro e Controlo de Execução {deploy-seguro:canon:rastreabilidade}
...
## 📌 Tabela de Rastreabilidade {deploy-seguro:canon:rastreabilidade#tabela_de_rastreabilidade}
...
## 🧠 Notas explicativas por framework {deploy-seguro:canon:rastreabilidade#notas_explicativas_por_framework}

### 🔹 NIST SSDF v1.1 {deploy-seguro:canon:rastreabilidade#nist_ssdf_v11}
...
### 🔹 OWASP SAMM v2.1 {deploy-seguro:canon:rastreabilidade#owasp_samm_v21}
...
### 🔹 BSIMM13 {deploy-seguro:canon:rastreabilidade#bsimm13}
...
### 🔹 SLSA v1.0 {deploy-seguro:canon:rastreabilidade#slsa_v10}
...
### 🔹 ISO/IEC 27001 {deploy-seguro:canon:rastreabilidade#isoiec_27001}
...
### 🔹 CIS Controls v8 {deploy-seguro:canon:rastreabilidade#cis_controls_v8}
...
### 🔹 ENISA DevSecOps {deploy-seguro:canon:rastreabilidade#enisa_devsecops}
...
### 🔹 OWASP DSOMM {deploy-seguro:canon:rastreabilidade#owasp_dsomm}
...
## 🔗 Ligações com outros capítulos {deploy-seguro:canon:rastreabilidade#ligacoes_com_outros_capitulos}
