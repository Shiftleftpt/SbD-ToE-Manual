...
# 📂 Controlo de Registos e Origem de Pacotes {dependencias-sbom-sca:addon:controle-registos-origem}

## 🌟 Objetivo {dependencias-sbom-sca:addon:controle-registos-origem#objetivo}
...
## 🔢 Conceito de repositório confiável {dependencias-sbom-sca:addon:controle-registos-origem#conceito_de_repositorio_confiavel}
...
## 🏠 Opções técnicas para registo interno {dependencias-sbom-sca:addon:controle-registos-origem#opcoes_tecnicas_para_registo_interno}
...
## 🚀 Estratégia de fallback controlado {dependencias-sbom-sca:addon:controle-registos-origem#estrategia_de_fallback_controlado}
...
## 📝 Recomendações de configuração {dependencias-sbom-sca:addon:controle-registos-origem#recomendacoes_de_configuracao}
...
## ✅ Benefícios adicionais {dependencias-sbom-sca:addon:controle-registos-origem#beneficios_adicionais}
...
## 🔗 Ligações com outros ficheiros {dependencias-sbom-sca:addon:controle-registos-origem#ligacoes_com_outros_ficheiros}
