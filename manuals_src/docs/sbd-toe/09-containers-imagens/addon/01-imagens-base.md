...
# 🧱 Imagens Base Seguras e Minimalistas {containers-imagens:addon:imagens-base}

## 🌟 Objetivo {containers-imagens:addon:imagens-base#objetivo}
...
## 🧬 O que é uma imagem base segura {containers-imagens:addon:imagens-base#o_que_e_uma_imagem_base_segura}
...
## 📘 Exemplos de imagens recomendadas {containers-imagens:addon:imagens-base#exemplos_de_imagens_recomendadas}
...
## 🛠️ Como aplicar {containers-imagens:addon:imagens-base#como_aplicar}
...
## 📂 Onde manter imagens base aprovadas {containers-imagens:addon:imagens-base#onde_manter_imagens_base_aprovadas}
...
## ✅ Boas práticas {containers-imagens:addon:imagens-base#boas_praticas}
...
## 📎 Referências cruzadas {containers-imagens:addon:imagens-base#referencias_cruzadas}
...
| `10-maturidade.md`               | Utilização de imagens validadas como critério de maturidade |
