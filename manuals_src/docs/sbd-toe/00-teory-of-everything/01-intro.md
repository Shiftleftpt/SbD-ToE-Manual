...
# Introdução — Theory of Everything {cap00:intro}
...
## 🌍 Origem e Motivação {cap00:intro#origem}
...
## 🧭 Filosofia Top-Down e Bottom-Up {cap00:intro#filosofia}
...
## 🛠️ Implementação e Autoavaliação {cap00:intro#aplicacao}
...
## 🔬 Fontes e Referências {cap00:intro#fontes}
...
## 👥 Papéis e Responsabilidades {cap00:intro#roles}
...
## 📐 Proporcionalidade por Nível de Risco {cap00:intro#levels}
...
## 📎 Estrutura do Capítulo 00 {cap00:intro#estrutura}

O Capítulo 00 organiza-se em documentos complementares:  

- `fundamentos.md` — explica princípios, passos de implementação e governação.  
- `roles.md` — lista papéis organizacionais e responsabilidades globais.  
- `responsabilidades-por-capitulo.md` — narrativa cruzada de papéis por capítulo.  
- `aplicacao-por-level.md` — “mapa da mina” de proporcionalidade L1–L3.  
- `obrigacoes-minimas.md` — núcleo duro do que é obrigatório em qualquer cenário.  
- `rationale-historico.md` — contextualiza a evolução e a designação *Theory of Everything*.  

Lidos em conjunto, estes textos oferecem uma narrativa coesa: **o que é o SbD-ToE, porque existe, como deve ser usado e como suporta também a conformidade regulatória em vigor**.
