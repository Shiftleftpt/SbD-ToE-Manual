...
# 📘 Capítulo 3 — Threat Modeling {threat-modeling:intro}

## 1. 🧭 O que cobre tecnicamente {threat-modeling:intro#1__o_que_cobre_tecnicamente}
...
## 2. 🧪 Prescrição prática: o quê, quem, como, quando, porquê e para quê {threat-modeling:intro#2__prescricao_pratica_o_que_quem_como_quando_porque_e_para_que}

### 🔐 Threat Modeling é a ponte entre risco, arquitetura e controlo aplicado {threat-modeling:intro#threat_modeling_e_a_ponte_entre_risco_arquitetura_e_controlo_aplicado}

> *"Sem Threat Modeling, o controlo aplicado perde contexto e os requisitos não têm origem validada."*

### 📌 O que deve ser feito {threat-modeling:intro#o_que_deve_ser_feito}
...
### ⚙️ Como deve ser feito {threat-modeling:intro#como_deve_ser_feito}
...
### 📆 Quando aplicar {threat-modeling:intro#quando_aplicar}
...
### 👥 Quem está envolvido {threat-modeling:intro#quem_esta_envolvido}
...
## 3. 🧭 Mapeamento para frameworks de maturidade {threat-modeling:intro#3__mapeamento_para_frameworks_de_maturidade}

Ver [addons/10-maturidade.md](xref:sbd-toe:toe:01-classificacao-aplicacoes:maturidade) para alinhamento detalhado com SAMM, BSIMM, SSDF e SLSA.

---

## 4. ⚠️ Caveats ou limitações da prescrição {threat-modeling:intro#4__caveats_ou_limitacoes_da_prescricao}
...
## 5. 💡 Exemplos de aplicação {threat-modeling:intro#5__exemplos_de_aplicacao}

- Ver [addons/05-exemplos-aplicacao.md](xref:sbd-toe:toe:02-requisitos-seguranca:exemplos-aplicacao)
- Ver [addons/08-exemplo-privacidade.md](xref:sbd-toe:toe:03-threat-modeling:exemplo-privacidade)
- Ver [addons/10-integracao-iriusrisk.md](xref:sbd-toe:toe:03-threat-modeling:integracao-iriusrisk)

---

## 6. 🔍 O que pode ser feito mais (e porquê) {threat-modeling:intro#6__o_que_pode_ser_feito_mais_e_porque}
...
## 7. ✅ Checklist de aplicação prática {threat-modeling:intro#7__checklist_de_aplicacao_pratica}

Checklist disponível em: [addons/20-checklist-revisao.md](xref:sbd-toe:toe:01-classificacao-aplicacoes:checklist-revisao)

---

## 🧩 Ligações a outros capítulos {threat-modeling:intro#ligacoes_a_outros_capitulos}
