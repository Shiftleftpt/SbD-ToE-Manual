...
# 🗾️ Diagramas de Apoio à Governança {governanca-contratacao:addon:diagramas-governanca}
...
## 📌 1. Fluxo de aprovação de exceção {governanca-contratacao:addon:diagramas-governanca#1_fluxo_de_aprovacao_de_excecao}
...
## 📅 2. Onboarding de fornecedor externo {governanca-contratacao:addon:diagramas-governanca#2_onboarding_de_fornecedor_externo}
...
## 🔗 3. Rastreabilidade organizacional {governanca-contratacao:addon:diagramas-governanca#3_rastreabilidade_organizacional}
...
## 🔄 4. Ciclo de revisão e validação continuada {governanca-contratacao:addon:diagramas-governanca#4_ciclo_de_revisao_e_validacao_continuada}
...
## 📆 5. Escalonamento de decisão de risco {governanca-contratacao:addon:diagramas-governanca#5_escalonamento_de_decisao_de_risco}
...
## 🧩 6. Governação de sistemas legados ou não conformes {governanca-contratacao:addon:diagramas-governanca#6_governacao_de_sistemas_legados_ou_nao_conformes}
...
## 🎓 7. Validação de formação obrigatória por função crítica {governanca-contratacao:addon:diagramas-governanca#7_validacao_de_formacao_obrigatoria_por_funcao_critica}
