...
# ✅ Checklist de Revisão Periódica — Deploy Seguro {deploy-seguro:canon:checklist-revisao}
...
## 📋 Itens de Verificação {deploy-seguro:canon:checklist-revisao#itens_de_verificacao}
...
## 🔄 Integração Operacional {deploy-seguro:canon:checklist-revisao#integracao_operacional}
...
## ✅ Conformidade e KPI {deploy-seguro:canon:checklist-revisao#conformidade_e_kpi}
