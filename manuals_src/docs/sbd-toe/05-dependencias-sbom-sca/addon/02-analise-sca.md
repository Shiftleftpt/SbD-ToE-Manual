...
# ⚠️ Análise de Vulnerabilidades em Dependências (SCA) {dependencias-sbom-sca:addon:analise-sca}

## 🌟 Objetivo {dependencias-sbom-sca:addon:analise-sca#objetivo}
...
## 🚀 Como funciona o processo de SCA {dependencias-sbom-sca:addon:analise-sca#como_funciona_o_processo_de_sca}
...
## 🤖 Ferramentas open source recomendadas {dependencias-sbom-sca:addon:analise-sca#ferramentas_open_source_recomendadas}
...
## 💳 Ferramentas comerciais com cobertura alargada {dependencias-sbom-sca:addon:analise-sca#ferramentas_comerciais_com_cobertura_alargada}
...
## 🌐 Integração no ciclo de vida {dependencias-sbom-sca:addon:analise-sca#integracao_no_ciclo_de_vida}
...
## ⚠️ Priorizando findings {dependencias-sbom-sca:addon:analise-sca#priorizando_findings}
...
## 🔗 Ligação com backlog e rastreabilidade {dependencias-sbom-sca:addon:analise-sca#ligacao_com_backlog_e_rastreabilidade}
...
## 🔒 Referências cruzadas {dependencias-sbom-sca:addon:analise-sca#referencias_cruzadas}
