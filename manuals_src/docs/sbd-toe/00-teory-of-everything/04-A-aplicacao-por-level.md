...
title: Aplicação por Nível de Risco — Theory of Everything
...
<a name="xref:cap00:levels"></a>

# Aplicação por Nível de Risco {cap00:levels}
...
## Nível L1 — Aplicações de Baixo Risco {cap00:levels#l1}
...
- Uso de imagens oficiais pinadas para containers (Cap. 09).  
...
## Nível L2 — Aplicações de Risco Moderado {cap00:levels#l2}
...
## Nível L3 — Aplicações de Alto Risco {cap00:levels#l3}
...
## Considerações Finais {cap00:levels#notas}
