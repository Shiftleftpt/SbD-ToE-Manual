...
# 🔐 Ameaças Mitigadas — Capítulo 02: Requisitos de Segurança {requisitos-seguranca:canon:ameacas-mitigadas}
...
## 📚 Categoria 1 – Falha na definição ou ausência de requisitos {requisitos-seguranca:canon:ameacas-mitigadas#categoria_1__falha_na_definicao_ou_ausencia_de_requisitos}
...
## 🧪 Categoria 2 – Validação deficiente de requisitos {requisitos-seguranca:canon:ameacas-mitigadas#categoria_2__validacao_deficiente_de_requisitos}
...
## 🧾 Categoria 3 – Gestão deficiente de exceções e escopo {requisitos-seguranca:canon:ameacas-mitigadas#categoria_3__gestao_deficiente_de_excecoes_e_escopo}
...
| Exceções não reverificadas no tempo    | NIST 800-30 / SSDF RM.3         | Requisito omitido para sempre                           | Checklist e ciclo de vida obrigam reavaliação de exceções                         | `canon/15-aplicacao-lifecycle.md`         | ❌ Cap. 01                             |

---

## 🔄 Categoria 4 – Falhas de rastreabilidade e cobertura {requisitos-seguranca:canon:ameacas-mitigadas#categoria_4__falhas_de_rastreabilidade_e_cobertura}
...
## ✅ Conclusão {requisitos-seguranca:canon:ameacas-mitigadas#conclusao}
