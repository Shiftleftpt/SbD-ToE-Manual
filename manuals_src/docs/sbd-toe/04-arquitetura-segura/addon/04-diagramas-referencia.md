...
# 🧹 Modelos de Arquitetura Segura Reutilizáveis {arquitetura-segura:addon:diagramas-referencia}
...
## 🧱 Modelo 1 — Monólito Web com Backend Interno (Risco L1) {arquitetura-segura:addon:diagramas-referencia#modelo_1__monolito_web_com_backend_interno_risco_l1}

### 📝 Descrição {arquitetura-segura:addon:diagramas-referencia#descricao}

- Aplicação tradicional com backend interno e base de dados local
- Sem APIs públicas
- Acesso controlado via rede privada

### ✔️ Requisitos aplicáveis {arquitetura-segura:addon:diagramas-referencia#requisitos_aplicaveis}

- `ARC-001` (Zonas de confiança)
- `ARC-003` (Fluxos representados)
- `ARC-007` (Uso de padrão aprovado)

### 🔑 Ameaças mitigadas {arquitetura-segura:addon:diagramas-referencia#ameacas_mitigadas}

- STRIDE: Tampering, Information Disclosure
- OSC&R: ARC-01, ARC-03

### 🖼️ Diagrama sugerido {arquitetura-segura:addon:diagramas-referencia#diagrama_sugerido}
...
## ☁️ Modelo 2 — Microserviços com APIs Externas (Risco L2) {arquitetura-segura:addon:diagramas-referencia#modelo_2__microservicos_com_apis_externas_risco_l2}
...
## 🧐 Modelo 3 — Plataforma Crítica Regulada (Risco L3) {arquitetura-segura:addon:diagramas-referencia#modelo_3__plataforma_critica_regulada_risco_l3}
...
## 📁 Sugestões de reutilização {arquitetura-segura:addon:diagramas-referencia#sugestoes_de_reutilizacao}
