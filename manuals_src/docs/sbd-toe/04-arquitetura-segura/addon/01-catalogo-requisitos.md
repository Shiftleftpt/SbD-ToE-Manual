...
# 📘 Catálogo de Requisitos Técnicos de Arquitetura Segura {arquitetura-segura:addon:01-catalogo-requisitos-aplicacionais}

## ❓ Porquê este catálogo está neste capítulo (e não apenas no Cap. 2) {arquitetura-segura:addon:01-catalogo-requisitos-aplicacionais#porque_este_catalogo_esta_neste_capitulo_e_nao_apenas_no_cap_2}
...
## 🧱 Requisitos Técnicos por Nível de Risco {arquitetura-segura:addon:01-catalogo-requisitos-aplicacionais#requisitos_tecnicos_por_nivel_de_risco}
...
## 🧩 Notas explicativas {arquitetura-segura:addon:01-catalogo-requisitos-aplicacionais#notas_explicativas}
...
## 🎯 Aplicação prática {arquitetura-segura:addon:01-catalogo-requisitos-aplicacionais#aplicacao_pratica}
...
## 🧾 Exemplos de evidência {arquitetura-segura:addon:01-catalogo-requisitos-aplicacionais#exemplos_de_evidencia}
...
> - [Capítulo 1 – Classificação de Risco](xref:sbd-toe:toe:intro:intro)
<!-- > - [Capítulo 2 – Requisitos de Segurança Globais](xref:sbd-toe:toe:intro:intro) -->
> - [Capítulo 3 – Threat Modeling](xref:sbd-toe:toe:intro:intro)
