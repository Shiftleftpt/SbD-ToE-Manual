...
# 🔐 Ameaças Mitigadas — Capítulo 06: Desenvolvimento Seguro {desenvolvimento-seguro:canon:ameacas-mitigadas}
...
## 🧑‍💻 Categoria 1 – Práticas inseguras de desenvolvimento {desenvolvimento-seguro:canon:ameacas-mitigadas#categoria_1__praticas_inseguras_de_desenvolvimento}
...
## 📉 Categoria 2 – Ausência de validação contínua e rastreável {desenvolvimento-seguro:canon:ameacas-mitigadas#categoria_2__ausencia_de_validacao_continua_e_rastreavel}
...
## 🔁 Categoria 3 – Gestão informal de exceções técnicas {desenvolvimento-seguro:canon:ameacas-mitigadas#categoria_3__gestao_informal_de_excecoes_tecnicas}
...
| Exceções não revistas ou revalidadas         | SSDF RM.3 / CAPEC-1003            | Riscos permanecem por tempo indefinido                   | Revisão forçada por ciclo ou prazo anotado diretamente no código                   | `canon/15-aplicacao-lifecycle.md`             | ❌ Cap. 01                             |
...
## 🤖 Categoria 4 – Risco associado a uso inseguro de GenAI {desenvolvimento-seguro:canon:ameacas-mitigadas#categoria_4__risco_associado_a_uso_inseguro_de_genai}
...
## 🧬 Categoria 5 – Ameaças detetáveis por SBOM, mas mitigáveis antecipadamente {desenvolvimento-seguro:canon:ameacas-mitigadas#categoria_5__ameacas_detetaveis_por_sbom_mas_mitigaveis_antecipadamente}
...
## 🧠 Categoria 6 – Falta de cultura e normalização de práticas seguras {desenvolvimento-seguro:canon:ameacas-mitigadas#categoria_6__falta_de_cultura_e_normalizacao_de_praticas_seguras}
...
## ✅ Conclusão {desenvolvimento-seguro:canon:ameacas-mitigadas#conclusao}
