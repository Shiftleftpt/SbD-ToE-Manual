...
# 🛠️ Módulo Formativo – Pull Request Seguro {formacao-onboarding:addon:exemplo-manual-dev-pr}

## 🎯 Objetivo {formacao-onboarding:addon:exemplo-manual-dev-pr#objetivo}
...
## 📋 Pré-requisitos {formacao-onboarding:addon:exemplo-manual-dev-pr#pre_requisitos}
...
## 🧪 Formato da sessão {formacao-onboarding:addon:exemplo-manual-dev-pr#formato_da_sessao}
...
## 📦 Materiais necessários {formacao-onboarding:addon:exemplo-manual-dev-pr#materiais_necessarios}
...
## ✅ Critérios de conclusão {formacao-onboarding:addon:exemplo-manual-dev-pr#criterios_de_conclusao}
...
## 🔗 Referências cruzadas no SbD-ToE {formacao-onboarding:addon:exemplo-manual-dev-pr#referencias_cruzadas_no_sbd_toe}
...
## 🧭 Recomendações operacionais {formacao-onboarding:addon:exemplo-manual-dev-pr#recomendacoes_operacionais}
