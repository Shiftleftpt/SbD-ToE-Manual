...
# 🧪 Linters e Validações Locais de Segurança {desenvolvimento-seguro:addon:linters-validacoes}
...
## 📌 Objetivos {desenvolvimento-seguro:addon:linters-validacoes#objetivos}
...
## 👥 Quem deve aplicar {desenvolvimento-seguro:addon:linters-validacoes#quem_deve_aplicar}
...
## ⏱️ Quando aplicar {desenvolvimento-seguro:addon:linters-validacoes#quando_aplicar}
...
## 🧱 Requisitos mínimos {desenvolvimento-seguro:addon:linters-validacoes#requisitos_minimos}
...
## 🚨 Falhas comuns detetáveis com linters {desenvolvimento-seguro:addon:linters-validacoes#falhas_comuns_detetaveis_com_linters}
...
## ✅ Como validar {desenvolvimento-seguro:addon:linters-validacoes#como_validar}
...
## 🧾 Como evidenciar {desenvolvimento-seguro:addon:linters-validacoes#como_evidenciar}
...
## 🔄 Ligação a outras práticas {desenvolvimento-seguro:addon:linters-validacoes#ligacao_a_outras_praticas}
