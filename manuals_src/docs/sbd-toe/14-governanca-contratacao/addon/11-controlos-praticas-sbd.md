...
# 🧮 Controlo Sistemático das Práticas do SbD-ToE {governanca-contratacao:addon:controlos-praticas-sbd}
...
## 🧭 Governação das práticas por domínio técnico {governanca-contratacao:addon:controlos-praticas-sbd#governacao_das_praticas_por_dominio_tecnico}
...
## 🧩 Formato do controlo por aplicação {governanca-contratacao:addon:controlos-praticas-sbd#formato_do_controlo_por_aplicacao}
...
## 🔁 Ciclo de validação contínua {governanca-contratacao:addon:controlos-praticas-sbd#ciclo_de_validacao_continua}
...
## 📡 Supervisão, KPIs e Escalada {governanca-contratacao:addon:controlos-praticas-sbd#supervisao_kpis_e_escalada}
...
## ✅ Conclusão {governanca-contratacao:addon:controlos-praticas-sbd#conclusao}
