...
# 🛠️ Exemplos de Estrutura e Práticas Seguras em Projetos IaC {iac-infraestrutura:addon:exemplos-praticas-boas}

## 🌟 Objetivo {iac-infraestrutura:addon:exemplos-praticas-boas#objetivo}
...
## 📁 Estrutura recomendada de repositório {iac-infraestrutura:addon:exemplos-praticas-boas#estrutura_recomendada_de_repositorio}
...
## 🏷️ Exemplo de tagging obrigatório {iac-infraestrutura:addon:exemplos-praticas-boas#exemplo_de_tagging_obrigatorio}
...
## 🔐 Exemplo de controlo de permissões {iac-infraestrutura:addon:exemplos-praticas-boas#exemplo_de_controlo_de_permissoes}
...
# Aplicação de política mínima {iac-infraestrutura:addon:exemplos-praticas-boas}
...
## 🔄 Exemplo de uso seguro de módulos externos {iac-infraestrutura:addon:exemplos-praticas-boas#exemplo_de_uso_seguro_de_modulos_externos}
...
## 💪 Exemplo de workflow CI para validação {iac-infraestrutura:addon:exemplos-praticas-boas#exemplo_de_workflow_ci_para_validacao}
...
## 🏠 Template de pre-commit hook {iac-infraestrutura:addon:exemplos-praticas-boas#template_de_pre_commit_hook}
...
## 🔗 Ligação a requisitos {iac-infraestrutura:addon:exemplos-praticas-boas#ligacao_a_requisitos}
...
## ✅ Benefícios {iac-infraestrutura:addon:exemplos-praticas-boas#beneficios}
