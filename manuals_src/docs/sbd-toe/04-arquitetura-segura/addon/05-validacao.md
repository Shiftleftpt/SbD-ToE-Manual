...
# 📋 Validação Arquitetural — Critérios por Requisito {arquitetura-segura:addon:criterios-validacao}
...
## ✅ Validação por Requisito {arquitetura-segura:addon:criterios-validacao#validacao_por_requisito}
...
## 🎯 Aplicação prática por nível de risco {arquitetura-segura:addon:criterios-validacao#aplicacao_pratica_por_nivel_de_risco}
...
## 📎 Notas de apoio {arquitetura-segura:addon:criterios-validacao#notas_de_apoio}
...
- Os requisitos e validações estão alinhados com [`addon/01-catalogo-requisitos.md`](xref:sbd-toe:toe:02-requisitos-seguranca:catalogo-requisitos).
