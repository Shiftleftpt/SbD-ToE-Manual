...
title: Critérios de Aceitação dos Requisitos de Segurança
...
tags: [tipo:aceitacao, tema:requisitos, validação, auditoria, anexo]
sidebar_position: 12
---

<!--template: sbdtoe-addon -->

# 🛠️ Critérios de Aceitação dos Requisitos de Segurança {requisitos-seguranca:addon:criterios-aceitacao}
...
## 🔐 AUT — Autenticação e Identidade {requisitos-seguranca:addon:criterios-aceitacao#aut__autenticacao_e_identidade}
...
## 🔓 ACC — Controlo de Acesso {requisitos-seguranca:addon:criterios-aceitacao#acc__controlo_de_acesso}
...
## 📈 LOG — Registo e Monitorização {requisitos-seguranca:addon:criterios-aceitacao#log__registo_e_monitorizacao}
...
## 🕒 SES — Sessões e Estado {requisitos-seguranca:addon:criterios-aceitacao#ses__sessoes_e_estado}
...
## 🧹 VAL — Validação de Dados {requisitos-seguranca:addon:criterios-aceitacao#val__validacao_de_dados}
...
## ❗ ERR — Gestão de Erros {requisitos-seguranca:addon:criterios-aceitacao#err__gestao_de_erros}
...
## ⚙️ CFG — Configuração Segura {requisitos-seguranca:addon:criterios-aceitacao#cfg__configuracao_segura}
...
## 🌐 API — Segurança de APIs {requisitos-seguranca:addon:criterios-aceitacao#api__seguranca_de_apis}
...
## 📨 INT — Mensagens e Integrações {requisitos-seguranca:addon:criterios-aceitacao#int__mensagens_e_integracoes}
...
## 📄 REQ — Definição de Requisitos {requisitos-seguranca:addon:criterios-aceitacao#req__definicao_de_requisitos}
...
## 🛠️ DST — Distribuição de Artefactos {requisitos-seguranca:addon:criterios-aceitacao#dst__distribuicao_de_artefactos}
...
## 💻 IDE — Ferramentas de Desenvolvimento {requisitos-seguranca:addon:criterios-aceitacao#ide__ferramentas_de_desenvolvimento}
...
## 📌 Nota Final {requisitos-seguranca:addon:criterios-aceitacao#nota_final}
...
> Para ligação direta ao requisito correspondente, consultar o [Catálogo Base de Requisitos](xref:sbd-toe:toe:02-requisitos-seguranca:lista-requisitos-base).
