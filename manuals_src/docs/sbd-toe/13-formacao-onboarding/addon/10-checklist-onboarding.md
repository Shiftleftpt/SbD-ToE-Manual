...
# ✅ Checklist de Onboarding Técnico Seguro {formacao-onboarding:addon:checklist-onboarding}
...
## 📋 Itens a validar (por colaborador) {formacao-onboarding:addon:checklist-onboarding#itens_a_validar_por_colaborador}
...
## 🧭 Notas de aplicação {formacao-onboarding:addon:checklist-onboarding#notas_de_aplicacao}
...
## 🔗 Referências cruzadas {formacao-onboarding:addon:checklist-onboarding#referencias_cruzadas}
