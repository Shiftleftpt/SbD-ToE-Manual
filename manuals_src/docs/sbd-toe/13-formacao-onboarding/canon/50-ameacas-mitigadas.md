...
# 🔐 Ameaças Mitigadas — Capítulo 13: Formação e Onboarding Seguro {formacao-onboarding:canon:ameacas-mitigadas}
...
## 📚 Categoria 1 – Erros humanos evitáveis {formacao-onboarding:canon:ameacas-mitigadas#categoria_1__erros_humanos_evitaveis}
...
## 🔐 Categoria 2 – Acesso indevido ou onboarding negligente {formacao-onboarding:canon:ameacas-mitigadas#categoria_2__acesso_indevido_ou_onboarding_negligente}
...
## 🧠 Categoria 3 – Cultura e motivação fraca para segurança {formacao-onboarding:canon:ameacas-mitigadas#categoria_3__cultura_e_motivacao_fraca_para_seguranca}
...
## 📉 Categoria 4 – Falta de rastreabilidade e cobertura {formacao-onboarding:canon:ameacas-mitigadas#categoria_4__falta_de_rastreabilidade_e_cobertura}
...
## 🔗 Categoria 5 – Formação sem ligação à prática real {formacao-onboarding:canon:ameacas-mitigadas#categoria_5__formacao_sem_ligacao_a_pratica_real}
...
## ✅ Conclusão {formacao-onboarding:canon:ameacas-mitigadas#conclusao}
